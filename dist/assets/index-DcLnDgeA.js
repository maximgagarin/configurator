...
void main() {
	...
	`}function pg(r){let t=new WeakMap,e=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===jo||l===Ko,h=l===Ur||l===Ir;if(c||h){let u=t.get(o);const f=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==f)return e===null&&(e=new dh(r)),u=c?e.fromEquirectangular(o,u):e.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return c&&p&&p.height>0||h&&p&&i(p)?(e===null&&(e=new dh(r)),u=c?e.fromEquirectangular(o):e.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,t.set(o,u),o.addEventListener("dispose",s),u.texture):null}}}return o}function i(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function s(o){const l=o.target;l.removeEventListener("dispose",s);const c=t.get(l);c!==void 0&&(t.delete(l),c.dispose())}function a(){t=new WeakMap,e!==null&&(e.dispose(),e=null)}return{get:n,dispose:a}}function mg(r){const t={};function e(n){if(t[n]!==void 0)return t[n];let i;switch(n){case"WEBGL_depth_texture":i=r.getExtension("WEBGL_depth_texture")||r.getExtension("MOZ_WEBGL_depth_texture")||r.getExtension("WEBKIT_WEBGL_depth_texture");break;case"EXT_texture_filter_anisotropic":i=r.getExtension("EXT_texture_filter_anisotropic")||r.getExtension("MOZ_EXT_texture_filter_anisotropic")||r.getExtension("WEBKIT_EXT_texture_filter_anisotropic");break;case"WEBGL_compressed_texture_s3tc":i=r.getExtension("WEBGL_compressed_texture_s3tc")||r.getExtension("MOZ_WEBGL_compressed_texture_s3tc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_s3tc");break;case"WEBGL_compressed_texture_pvrtc":i=r.getExtension("WEBGL_compressed_texture_pvrtc")||r.getExtension("WEBKIT_WEBGL_compressed_texture_pvrtc");break;default:i=r.getExtension(n)}return t[n]=i,i}return{has:function(n){return e(n)!==null},init:function(){e("EXT_color_buffer_float"),e("WEBGL_clip_cull_distance"),e("OES_texture_float_linear"),e("EXT_color_buffer_half_float"),e("WEBGL_multisampled_render_to_texture"),e("WEBGL_render_shared_exponent")},get:function(n){const i=e(n);return i===null&&ls("THREE.WebGLRenderer: "+n+" extension not supported."),i}}}function _g(r,t,e,n){const i={},s=new WeakMap;function a(u){const f=u.target;f.index!==null&&t.remove(f.index);for(const g in f.attributes)t.remove(f.attributes[g]);for(const g in f.morphAttributes){const _=f.morphAttributes[g];for(let m=0,d=_.length;m<d;m++)t.remove(_[m])}f.removeEventListener("dispose",a),delete i[f.id];const p=s.get(f);p&&(t.remove(p),s.delete(f)),n.releaseStatesOfGeometry(f),f.isInstancedBufferGeometry===!0&&delete f._maxInstanceCount,e.memory.geometries--}function o(u,f){return i[f.id]===!0||(f.addEventListener("dispose",a),i[f.id]=!0,e.memory.geometries++),f}function l(u){const f=u.attributes;for(const g in f)t.update(f[g],r.ARRAY_BUFFER);const p=u.morphAttributes;for(const g in p){const _=p[g];for(let m=0,d=_.length;m<d;m++)t.update(_[m],r.ARRAY_BUFFER)}}function c(u){const f=[],p=u.index,g=u.attributes.position;let _=0;if(p!==null){const T=p.array;_=p.version;for(let E=0,x=T.length;E<x;E+=3){const R=T[E+0],w=T[E+1],b=T[E+2];f.push(R,w,w,b,b,R)}}else if(g!==void 0){const T=g.array;_=g.version;for(let E=0,x=T.length/3-1;E<x;E+=3){const R=E+0,w=E+1,b=E+2;f.push(R,w,w,b,b,R)}}else return;const m=new(bu(f)?Pu:Cu)(f,1);m.version=_;const d=s.get(u);d&&t.remove(d),s.set(u,m)}function h(u){const f=s.get(u);if(f){const p=u.index;p!==null&&f.version<p.version&&c(u)}else c(u);return s.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function gg(r,t,e){let n;function i(f){n=f}let s,a;function o(f){s=f.type,a=f.bytesPerElement}function l(f,p){r.drawElements(n,p,s,f*a),e.update(p,n,1)}function c(f,p,g){g!==0&&(r.drawElementsInstanced(n,p,s,f*a,g),e.update(p,n,g))}function h(f,p,g){if(g===0)return;t.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,s,f,0,g);let m=0;for(let d=0;d<g;d++)m+=p[d];e.update(m,n,1)}function u(f,p,g,_){if(g===0)return;const m=t.get("WEBGL_multi_draw");if(m===null)for(let d=0;d<f.length;d++)c(f[d]/a,p[d],_[d]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,s,f,0,_,0,g);let d=0;for(let T=0;T<g;T++)d+=p[T]*_[T];e.update(d,n,1)}}this.setMode=i,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function vg(r){const t={geometries:0,textures:0},e={frame:0,calls:0,triangles:0,points:0,lines:0};function n(s,a,o){switch(e.calls++,a){case r.TRIANGLES:e.triangles+=o*(s/3);break;case r.LINES:e.lines+=o*(s/2);break;case r.LINE_STRIP:e.lines+=o*(s-1);break;case r.LINE_LOOP:e.lines+=o*s;break;case r.POINTS:e.points+=o*s;break;default:console.error("THREE.WebGLInfo: Unknown draw mode:",a);break}}function i(){e.calls=0,e.triangles=0,e.points=0,e.lines=0}return{memory:t,render:e,programs:null,autoReset:!0,reset:i,update:n}}function xg(r,t,e){const n=new WeakMap,i=new de;function s(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let f=n.get(o);if(f===void 0||f.count!==u){let S=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",S)};var p=S;f!==void 0&&f.texture.dispose();const g=o.morphAttributes.position!==void 0,_=o.morphAttributes.normal!==void 0,m=o.morphAttributes.color!==void 0,d=o.morphAttributes.position||[],T=o.morphAttributes.normal||[],E=o.morphAttributes.color||[];let x=0;g===!0&&(x=1),_===!0&&(x=2),m===!0&&(x=3);let R=o.attributes.position.count*x,w=1;R>t.maxTextureSize&&(w=Math.ceil(R/t.maxTextureSize),R=t.maxTextureSize);const b=new Float32Array(R*w*4*u),C=new wu(b,R,w,u);C.type=Jn,C.needsUpdate=!0;const v=x*4;for(let P=0;P<u;P++){const k=d[P],O=T[P],X=E[P],Y=R*w*4*P;for(let V=0;V<k.count;V++){const q=V*v;g===!0&&(i.fromBufferAttribute(k,V),b[Y+q+0]=i.x,b[Y+q+1]=i.y,b[Y+q+2]=i.z,b[Y+q+3]=0),_===!0&&(i.fromBufferAttribute(O,V),b[Y+q+4]=i.x,b[Y+q+5]=i.y,b[Y+q+6]=i.z,b[Y+q+7]=0),m===!0&&(i.fromBufferAttribute(X,V),b[Y+q+8]=i.x,b[Y+q+9]=i.y,b[Y+q+10]=i.z,b[Y+q+11]=X.itemSize===4?i.w:1)}}f={count:u,texture:C,size:new Rt(R,w)},n.set(o,f),o.addEventListener("dispose",S)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(r,"morphTexture",a.morphTexture,e);else{let g=0;for(let m=0;m<c.length;m++)g+=c[m];const _=o.morphTargetsRelative?1:1-g;l.getUniforms().setValue(r,"morphTargetBaseInfluence",_),l.getUniforms().setValue(r,"morphTargetInfluences",c)}l.getUniforms().setValue(r,"morphTargetsTexture",f.texture,e),l.getUniforms().setValue(r,"morphTargetsTextureSize",f.size)}return{update:s}}function Mg(r,t,e,n){let i=new WeakMap;function s(l){const c=n.render.frame,h=l.geometry,u=t.get(l,h);if(i.get(u)!==c&&(t.update(u),i.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),i.get(l)!==c&&(e.update(l.instanceMatrix,r.ARRAY_BUFFER),l.instanceColor!==null&&e.update(l.instanceColor,r.ARRAY_BUFFER),i.set(l,c))),l.isSkinnedMesh){const f=l.skeleton;i.get(f)!==c&&(f.update(),i.set(f,c))}return u}function a(){i=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),e.remove(c.instanceMatrix),c.instanceColor!==null&&e.remove(c.instanceColor)}return{update:s,dispose:a}}class Nu extends Ge{constructor(t,e,n,i,s,a,o,l,c,h=Ar){if(h!==Ar&&h!==Or)throw new Error("DepthTexture format must be either THREE.DepthFormat or THREE.DepthStencilFormat");n===void 0&&h===Ar&&(n=ji),n===void 0&&h===Or&&(n=Nr),super(null,i,s,a,o,l,h,n,c),this.isDepthTexture=!0,this.image={width:t,height:e},this.magFilter=o!==void 0?o:Cn,this.minFilter=l!==void 0?l:Cn,this.flipY=!1,this.generateMipmaps=!1,this.compareFunction=null}copy(t){return super.copy(t),this.compareFunction=t.compareFunction,this}toJSON(t){const e=super.toJSON(t);return this.compareFunction!==null&&(e.compareFunction=this.compareFunction),e}}const Ou=new Ge,gh=new Nu(1,1),Fu=new wu,Bu=new ap,zu=new Lu,vh=[],xh=[],Mh=new Float32Array(16),Sh=new Float32Array(9),yh=new Float32Array(4);function Zr(r,t,e){const n=r[0];if(n<=0||n>0)return r;const i=t*e;let s=vh[i];if(s===void 0&&(s=new Float32Array(i),vh[i]=s),t!==0){n.toArray(s,0);for(let a=1,o=0;a!==t;++a)o+=e,r[a].toArray(s,o)}return s}function Ee(r,t){if(r.length!==t.length)return!1;for(let e=0,n=r.length;e<n;e++)if(r[e]!==t[e])return!1;return!0}function Te(r,t){for(let e=0,n=t.length;e<n;e++)r[e]=t[e]}function ka(r,t){let e=xh[t];e===void 0&&(e=new Int32Array(t),xh[t]=e);for(let n=0;n!==t;++n)e[n]=r.allocateTextureUnit();return e}function Sg(r,t){const e=this.cache;e[0]!==t&&(r.uniform1f(this.addr,t),e[0]=t)}function yg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2f(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;r.uniform2fv(this.addr,t),Te(e,t)}}function Eg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3f(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else if(t.r!==void 0)(e[0]!==t.r||e[1]!==t.g||e[2]!==t.b)&&(r.uniform3f(this.addr,t.r,t.g,t.b),e[0]=t.r,e[1]=t.g,e[2]=t.b);else{if(Ee(e,t))return;r.uniform3fv(this.addr,t),Te(e,t)}}function Tg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4f(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;r.uniform4fv(this.addr,t),Te(e,t)}}function bg(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;r.uniformMatrix2fv(this.addr,!1,t),Te(e,t)}else{if(Ee(e,n))return;yh.set(n),r.uniformMatrix2fv(this.addr,!1,yh),Te(e,n)}}function Ag(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;r.uniformMatrix3fv(this.addr,!1,t),Te(e,t)}else{if(Ee(e,n))return;Sh.set(n),r.uniformMatrix3fv(this.addr,!1,Sh),Te(e,n)}}function wg(r,t){const e=this.cache,n=t.elements;if(n===void 0){if(Ee(e,t))return;r.uniformMatrix4fv(this.addr,!1,t),Te(e,t)}else{if(Ee(e,n))return;Mh.set(n),r.uniformMatrix4fv(this.addr,!1,Mh),Te(e,n)}}function Rg(r,t){const e=this.cache;e[0]!==t&&(r.uniform1i(this.addr,t),e[0]=t)}function Cg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2i(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;r.uniform2iv(this.addr,t),Te(e,t)}}function Pg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3i(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ee(e,t))return;r.uniform3iv(this.addr,t),Te(e,t)}}function Dg(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4i(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;r.uniform4iv(this.addr,t),Te(e,t)}}function Lg(r,t){const e=this.cache;e[0]!==t&&(r.uniform1ui(this.addr,t),e[0]=t)}function Ug(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y)&&(r.uniform2ui(this.addr,t.x,t.y),e[0]=t.x,e[1]=t.y);else{if(Ee(e,t))return;r.uniform2uiv(this.addr,t),Te(e,t)}}function Ig(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z)&&(r.uniform3ui(this.addr,t.x,t.y,t.z),e[0]=t.x,e[1]=t.y,e[2]=t.z);else{if(Ee(e,t))return;r.uniform3uiv(this.addr,t),Te(e,t)}}function Ng(r,t){const e=this.cache;if(t.x!==void 0)(e[0]!==t.x||e[1]!==t.y||e[2]!==t.z||e[3]!==t.w)&&(r.uniform4ui(this.addr,t.x,t.y,t.z,t.w),e[0]=t.x,e[1]=t.y,e[2]=t.z,e[3]=t.w);else{if(Ee(e,t))return;r.uniform4uiv(this.addr,t),Te(e,t)}}function Og(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i);let s;this.type===r.SAMPLER_2D_SHADOW?(gh.compareFunction=Tu,s=gh):s=Ou,e.setTexture2D(t||s,i)}function Fg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture3D(t||Bu,i)}function Bg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTextureCube(t||zu,i)}function zg(r,t,e){const n=this.cache,i=e.allocateTextureUnit();n[0]!==i&&(r.uniform1i(this.addr,i),n[0]=i),e.setTexture2DArray(t||Fu,i)}function kg(r){switch(r){case 5126:return Sg;case 35664:return yg;case 35665:return Eg;case 35666:return Tg;case 35674:return bg;case 35675:return Ag;case 35676:return wg;case 5124:case 35670:return Rg;case 35667:case 35671:return Cg;case 35668:case 35672:return Pg;case 35669:case 35673:return Dg;case 5125:return Lg;case 36294:return Ug;case 36295:return Ig;case 36296:return Ng;case 35678:case 36198:case 36298:case 36306:case 35682:return Og;case 35679:case 36299:case 36307:return Fg;case 35680:case 36300:case 36308:case 36293:return Bg;case 36289:case 36303:case 36311:case 36292:return zg}}function Hg(r,t){r.uniform1fv(this.addr,t)}function Vg(r,t){const e=Zr(t,this.size,2);r.uniform2fv(this.addr,e)}function Gg(r,t){const e=Zr(t,this.size,3);r.uniform3fv(this.addr,e)}function Wg(r,t){const e=Zr(t,this.size,4);r.uniform4fv(this.addr,e)}function Xg(r,t){const e=Zr(t,this.size,4);r.uniformMatrix2fv(this.addr,!1,e)}function Yg(r,t){const e=Zr(t,this.size,9);r.uniformMatrix3fv(this.addr,!1,e)}function qg(r,t){const e=Zr(t,this.size,16);r.uniformMatrix4fv(this.addr,!1,e)}function Zg(r,t){r.uniform1iv(this.addr,t)}function jg(r,t){r.uniform2iv(this.addr,t)}function Kg(r,t){r.uniform3iv(this.addr,t)}function $g(r,t){r.uniform4iv(this.addr,t)}function Jg(r,t){r.uniform1uiv(this.addr,t)}function Qg(r,t){r.uniform2uiv(this.addr,t)}function t0(r,t){r.uniform3uiv(this.addr,t)}function e0(r,t){r.uniform4uiv(this.addr,t)}function n0(r,t,e){const n=this.cache,i=t.length,s=ka(e,i);Ee(n,s)||(r.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==i;++a)e.setTexture2D(t[a]||Ou,s[a])}function i0(r,t,e){const n=this.cache,i=t.length,s=ka(e,i);Ee(n,s)||(r.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==i;++a)e.setTexture3D(t[a]||Bu,s[a])}function r0(r,t,e){const n=this.cache,i=t.length,s=ka(e,i);Ee(n,s)||(r.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==i;++a)e.setTextureCube(t[a]||zu,s[a])}function s0(r,t,e){const n=this.cache,i=t.length,s=ka(e,i);Ee(n,s)||(r.uniform1iv(this.addr,s),Te(n,s));for(let a=0;a!==i;++a)e.setTexture2DArray(t[a]||Fu,s[a])}function a0(r){switch(r){case 5126:return Hg;case 35664:return Vg;case 35665:return Gg;case 35666:return Wg;case 35674:return Xg;case 35675:return Yg;case 35676:return qg;case 5124:case 35670:return Zg;case 35667:case 35671:return jg;case 35668:case 35672:return Kg;case 35669:case 35673:return $g;case 5125:return Jg;case 36294:return Qg;case 36295:return t0;case 36296:return e0;case 35678:case 36198:case 36298:case 36306:case 35682:return n0;case 35679:case 36299:case 36307:return i0;case 35680:case 36300:case 36308:case 36293:return r0;case 36289:case 36303:case 36311:case 36292:return s0}}class o0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.setValue=kg(e.type)}}class l0{constructor(t,e,n){this.id=t,this.addr=n,this.cache=[],this.type=e.type,this.size=e.size,this.setValue=a0(e.type)}}class c0{constructor(t){this.id=t,this.seq=[],this.map={}}setValue(t,e,n){const i=this.seq;for(let s=0,a=i.length;s!==a;++s){const o=i[s];o.setValue(t,e[o.id],n)}}}const To=/(\w+)(\])?(\[|\.)?/g;function Eh(r,t){r.seq.push(t),r.map[t.id]=t}function h0(r,t,e){const n=r.name,i=n.length;for(To.lastIndex=0;;){const s=To.exec(n),a=To.lastIndex;let o=s[1];const l=s[2]==="]",c=s[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===i){Eh(e,c===void 0?new o0(o,r,t):new l0(o,r,t));break}else{let u=e.map[o];u===void 0&&(u=new c0(o),Eh(e,u)),e=u}}}class va{constructor(t,e){this.seq=[],this.map={};const n=t.getProgramParameter(e,t.ACTIVE_UNIFORMS);for(let i=0;i<n;++i){const s=t.getActiveUniform(e,i),a=t.getUniformLocation(e,s.name);h0(s,a,this)}}setValue(t,e,n,i){const s=this.map[e];s!==void 0&&s.setValue(t,n,i)}setOptional(t,e,n){const i=e[n];i!==void 0&&this.setValue(t,n,i)}static upload(t,e,n,i){for(let s=0,a=e.length;s!==a;++s){const o=e[s],l=n[o.id];l.needsUpdate!==!1&&o.setValue(t,l.value,i)}}static seqWithValue(t,e){const n=[];for(let i=0,s=t.length;i!==s;++i){const a=t[i];a.id in e&&n.push(a)}return n}}function Th(r,t,e){const n=r.createShader(t);return r.shaderSource(n,e),r.compileShader(n),n}const u0=37297;let f0=0;function d0(r,t){const e=r.split(`
`),n=[],i=Math.max(t-6,0),s=Math.min(t+6,e.length);for(let a=i;a<s;a++){const o=a+1;n.push(`${o===t?">":" "} ${o}: ${e[a]}`)}return n.join(`
`)}const bh=new Dt;function p0(r){Vt._getMatrix(bh,Vt.workingColorSpace,r);const t=`mat3( ${bh.elements.map(e=>e.toFixed(4))} )`;switch(Vt.getTransfer(r)){case Oa:return[t,"LinearTransferOETF"];case $t:return[t,"sRGBTransferOETF"];default:return console.warn("THREE.WebGLProgram: Unsupported color space: ",r),[t,"LinearTransferOETF"]}}function Ah(r,t,e){const n=r.getShaderParameter(t,r.COMPILE_STATUS),i=r.getShaderInfoLog(t).trim();if(n&&i==="")return"";const s=/ERROR: 0:(\d+)/.exec(i);if(s){const a=parseInt(s[1]);return e.toUpperCase()+`

`+i+`

`+d0(r.getShaderSource(t),a)}else return i}function m0(r,t){const e=p0(t);return[`vec4 ${r}( vec4 value ) {`,`	return ${e[1]}( vec4( value.rgb * ${e[0]}, value.a ) );`,"}"].join(`
`)}function _0(r,t){let e;switch(t){case gd:e="Linear";break;case vd:e="Reinhard";break;case xd:e="Cineon";break;case Md:e="ACESFilmic";break;case yd:e="AgX";break;case Ed:e="Neutral";break;case Sd:e="Custom";break;default:console.warn("THREE.WebGLProgram: Unsupported toneMapping:",t),e="Linear"}return"vec3 "+r+"( vec3 color ) { return "+e+"ToneMapping( color ); }"}const na=new N;function g0(){Vt.getLuminanceCoefficients(na);const r=na.x.toFixed(4),t=na.y.toFixed(4),e=na.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${r}, ${t}, ${e} );`,"	return dot( weights, rgb );","}"].join(`
`)}function v0(r){return[r.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",r.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(cs).join(`
`)}function x0(r){const t=[];for(const e in r){const n=r[e];n!==!1&&t.push("#define "+e+" "+n)}return t.join(`
`)}function M0(r,t){const e={},n=r.getProgramParameter(t,r.ACTIVE_ATTRIBUTES);for(let i=0;i<n;i++){const s=r.getActiveAttrib(t,i),a=s.name;let o=1;s.type===r.FLOAT_MAT2&&(o=2),s.type===r.FLOAT_MAT3&&(o=3),s.type===r.FLOAT_MAT4&&(o=4),e[a]={type:s.type,location:r.getAttribLocation(t,a),locationSize:o}}return e}function cs(r){return r!==""}function wh(r,t){const e=t.numSpotLightShadows+t.numSpotLightMaps-t.numSpotLightShadowsWithMaps;return r.replace(/NUM_DIR_LIGHTS/g,t.numDirLights).replace(/NUM_SPOT_LIGHTS/g,t.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,t.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,e).replace(/NUM_RECT_AREA_LIGHTS/g,t.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,t.numPointLights).replace(/NUM_HEMI_LIGHTS/g,t.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,t.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,t.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,t.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,t.numPointLightShadows)}function Rh(r,t){return r.replace(/NUM_CLIPPING_PLANES/g,t.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,t.numClippingPlanes-t.numClipIntersection)}const S0=/^[ \t]*#include +<([\w\d./]+)>/gm;function Tl(r){return r.replace(S0,E0)}const y0=new Map;function E0(r,t){let e=Ut[t];if(e===void 0){const n=y0.get(t);if(n!==void 0)e=Ut[n],console.warn('THREE.WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',t,n);else throw new Error("Can not resolve #include <"+t+">")}return Tl(e)}const T0=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Ch(r){return r.replace(T0,b0)}function b0(r,t,e,n){let i="";for(let s=parseInt(t);s<parseInt(e);s++)i+=n.replace(/\[\s*i\s*\]/g,"[ "+s+" ]").replace(/UNROLLED_LOOP_INDEX/g,s);return i}function Ph(r){let t=`precision ${r.precision} float;
...
#define LOW_PRECISION`),t}function A0(r){let t="SHADOWMAP_TYPE_BASIC";return r.shadowMapType===cu?t="SHADOWMAP_TYPE_PCF":r.shadowMapType===hu?t="SHADOWMAP_TYPE_PCF_SOFT":r.shadowMapType===Zn&&(t="SHADOWMAP_TYPE_VSM"),t}function w0(r){let t="ENVMAP_TYPE_CUBE";if(r.envMap)switch(r.envMapMode){case Ur:case Ir:t="ENVMAP_TYPE_CUBE";break;case Na:t="ENVMAP_TYPE_CUBE_UV";break}return t}function R0(r){let t="ENVMAP_MODE_REFLECTION";if(r.envMap)switch(r.envMapMode){case Ir:t="ENVMAP_MODE_REFRACTION";break}return t}function C0(r){let t="ENVMAP_BLENDING_NONE";if(r.envMap)switch(r.combine){case uu:t="ENVMAP_BLENDING_MULTIPLY";break;case md:t="ENVMAP_BLENDING_MIX";break;case _d:t="ENVMAP_BLENDING_ADD";break}return t}function P0(r){const t=r.envMapCubeUVHeight;if(t===null)return null;const e=Math.log2(t)-2,n=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,e),7*16)),texelHeight:n,maxMip:e}}function D0(r,t,e,n){const i=r.getContext(),s=e.defines;let a=e.vertexShader,o=e.fragmentShader;const l=A0(e),c=w0(e),h=R0(e),u=C0(e),f=P0(e),p=v0(e),g=x0(s),_=i.createProgram();let m,d,T=e.glslVersion?"#version "+e.glslVersion+`
...
*/var hn={autoSleep:120,force3D:"auto",nullTargetWarn:1,units:{lineHeight:""}},zr={duration:.5,overwrite:!1,delay:0},ac,Be,ae,xn=1e8,ne=1/xn,Al=Math.PI*2,ax=Al/4,ox=0,Xu=Math.sqrt,lx=Math.cos,cx=Math.sin,we=function(t){return typeof t=="string"},pe=function(t){return typeof t=="function"},ri=function(t){return typeof t=="number"},oc=function(t){return typeof t>"u"},kn=function(t){return typeof t=="object"},$e=function(t){return t!==!1},lc=function(){return typeof window<"u"},ha=function(t){return pe(t)||we(t)},Yu=typeof ArrayBuffer=="function"&&ArrayBuffer.isView||function(){},ze=Array.isArray,wl=/(?:-?\.?\d|\.)+/gi,qu=/[-+=.]*\d+[.e\-+]*\d*[e\-+]*\d*/g,yr=/[-+=.]*\d+[.e-]*\d*[a-z%]*/g,Do=/[-+=.]*\d+\.?\d*(?:e-|e\+)?\d*/gi,Zu=/[+-]=-?[.\d]+/,ju=/[^,'"\[\]\s]+/gi,hx=/^[+\-=e\s\d]*\d+[.\d]*([a-z]*|%)\s*$/i,ce,Ln,Rl,cc,un={},Ra={},Ku,$u=function(t){return(Ra=Ji(t,un))&&en},hc=function(t,e){return console.warn("Invalid property",t,"set to",e,"Missing plugin? gsap.registerPlugin()")},Ss=function(t,e){return!e&&console.warn(t)},Ju=function(t,e){return t&&(un[t]=e)&&Ra&&(Ra[t]=e)||un},ys=function(){return 0},ux={suppressEvents:!0,isStart:!0,kill:!1},xa={suppressEvents:!0,kill:!1},fx={suppressEvents:!0},uc={},yi=[],Cl={},Qu,an={},Lo={},qh=30,Ma=[],fc="",dc=function(t){var e=t[0],n,i;if(kn(e)||pe(e)||(t=[t]),!(n=(e._gsap||{}).harness)){for(i=Ma.length;i--&&!Ma[i].targetTest(e););n=Ma[i]}for(i=t.length;i--;)t[i]&&(t[i]._gsap||(t[i]._gsap=new Tf(t[i],n)))||t.splice(i,1);return t},Xi=function(t){return t._gsap||dc(Mn(t))[0]._gsap},tf=function(t,e,n){return(n=t[e])&&pe(n)?t[e]():oc(n)&&t.getAttribute&&t.getAttribute(e)||n},Je=function(t,e){return(t=t.split(",")).forEach(e)||t},ge=function(t){return Math.round(t*1e5)/1e5||0},Ae=function(t){return Math.round(t*1e7)/1e7||0},Cr=function(t,e){var n=e.charAt(0),i=parseFloat(e.substr(2));return t=parseFloat(t),n==="+"?t+i:n==="-"?t-i:n==="*"?t*i:t/i},dx=function(t,e){for(var n=e.length,i=0;t.indexOf(e[i])<0&&++i<n;);return i<n},Ca=function(){var t=yi.length,e=yi.slice(0),n,i;for(Cl={},yi.length=0,n=0;n<t;n++)i=e[n],i&&i._lazy&&(i.render(i._lazy[0],i._lazy[1],!0)._lazy=0)},ef=function(t,e,n,i){yi.length&&!Be&&Ca(),t.render(e,n,Be&&e<0&&(t._initted||t._startAt)),yi.length&&!Be&&Ca()},nf=function(t){var e=parseFloat(t);return(e||e===0)&&(t+"").match(ju).length<2?e:we(t)?t.trim():t},rf=function(t){return t},Sn=function(t,e){for(var n in e)n in t||(t[n]=e[n]);return t},px=function(t){return function(e,n){for(var i in n)i in e||i==="duration"&&t||i==="ease"||(e[i]=n[i])}},Ji=function(t,e){for(var n in e)t[n]=e[n];return t},Zh=function r(t,e){for(var n in e)n!=="__proto__"&&n!=="constructor"&&n!=="prototype"&&(t[n]=kn(e[n])?r(t[n]||(t[n]={}),e[n]):e[n]);return t},Pa=function(t,e){var n={},i;for(i in t)i in e||(n[i]=t[i]);return n},ds=function(t){var e=t.parent||ce,n=t.keyframes?px(ze(t.keyframes)):Sn;if($e(t.inherit))for(;e;)n(t,e.vars.defaults),e=e.parent||e._dp;return t},mx=function(t,e){for(var n=t.length,i=n===e.length;i&&n--&&t[n]===e[n];);return n<0},sf=function(t,e,n,i,s){var a=t[i],o;if(s)for(o=e[s];a&&a[s]>o;)a=a._prev;return a?(e._next=a._next,a._next=e):(e._next=t[n],t[n]=e),e._next?e._next._prev=e:t[i]=e,e._prev=a,e.parent=e._dp=t,e},qa=function(t,e,n,i){n===void 0&&(n="_first"),i===void 0&&(i="_last");var s=e._prev,a=e._next;s?s._next=a:t[n]===e&&(t[n]=a),a?a._prev=s:t[i]===e&&(t[i]=s),e._next=e._prev=e.parent=null},Ai=function(t,e){t.parent&&(!e||t.parent.autoRemoveChildren)&&t.parent.remove&&t.parent.remove(t),t._act=0},Yi=function(t,e){if(t&&(!e||e._end>t._dur||e._start<0))for(var n=t;n;)n._dirty=1,n=n.parent;return t},_x=function(t){for(var e=t.parent;e&&e.parent;)e._dirty=1,e.totalDuration(),e=e.parent;return t},Pl=function(t,e,n,i){return t._startAt&&(Be?t._startAt.revert(xa):t.vars.immediateRender&&!t.vars.autoRevert||t._startAt.render(e,!0,i))},gx=function r(t){return!t||t._ts&&r(t.parent)},jh=function(t){return t._repeat?kr(t._tTime,t=t.duration()+t._rDelay)*t:0},kr=function(t,e){var n=Math.floor(t/=e);return t&&n===t?n-1:n},Da=function(t,e){return(t-e._start)*e._ts+(e._ts>=0?0:e._dirty?e.totalDuration():e._tDur)},Za=function(t){return t._end=Ae(t._start+(t._tDur/Math.abs(t._ts||t._rts||ne)||0))},ja=function(t,e){var n=t._dp;return n&&n.smoothChildTiming&&t._ts&&(t._start=Ae(n._time-(t._ts>0?e/t._ts:((t._dirty?t.totalDuration():t._tDur)-e)/-t._ts)),Za(t),n._dirty||Yi(n,t)),t},af=function(t,e){var n;if((e._time||!e._dur&&e._initted||e._start<t._time&&(e._dur||!e.add))&&(n=Da(t.rawTime(),e),(!e._dur||Us(0,e.totalDuration(),n)-e._tTime>ne)&&e.render(n,!0)),Yi(t,e)._dp&&t._initted&&t._time>=t._dur&&t._ts){if(t._dur<t.duration())for(n=t;n._dp;)n.rawTime()>=0&&n.totalTime(n._tTime),n=n._dp;t._zTime=-ne}},In=function(t,e,n,i){return e.parent&&Ai(e),e._start=Ae((ri(n)?n:n||t!==ce?mn(t,n,e):t._time)+e._delay),e._end=Ae(e._start+(e.totalDuration()/Math.abs(e.timeScale())||0)),sf(t,e,"_first","_last",t._sort?"_start":0),Dl(e)||(t._recent=e),i||af(t,e),t._ts<0&&ja(t,t._tTime),t},of=function(t,e){return(un.ScrollTrigger||hc("scrollTrigger",e))&&un.ScrollTrigger.create(e,t)},lf=function(t,e,n,i,s){if(mc(t,e,s),!t._initted)return 1;if(!n&&t._pt&&!Be&&(t._dur&&t.vars.lazy!==!1||!t._dur&&t.vars.lazy)&&Qu!==on.frame)return yi.push(t),t._lazy=[s,i],1},vx=function r(t){var e=t.parent;return e&&e._ts&&e._initted&&!e._lock&&(e.rawTime()<0||r(e))},Dl=function(t){var e=t.data;return e==="isFromStart"||e==="isStart"},xx=function(t,e,n,i){var s=t.ratio,a=e<0||!e&&(!t._start&&vx(t)&&!(!t._initted&&Dl(t))||(t._ts<0||t._dp._ts<0)&&!Dl(t))?0:1,o=t._rDelay,l=0,c,h,u;if(o&&t._repeat&&(l=Us(0,t._tDur,e),h=kr(l,o),t._yoyo&&h&1&&(a=1-a),h!==kr(t._tTime,o)&&(s=1-a,t.vars.repeatRefresh&&t._initted&&t.invalidate())),a!==s||Be||i||t._zTime===ne||!e&&t._zTime){if(!t._initted&&lf(t,e,i,n,l))return;for(u=t._zTime,t._zTime=e||(n?ne:0),n||(n=e&&!u),t.ratio=a,t._from&&(a=1-a),t._time=0,t._tTime=l,c=t._pt;c;)c.r(a,c.d),c=c._next;e<0&&Pl(t,e,n,!0),t._onUpdate&&!n&&cn(t,"onUpdate"),l&&t._repeat&&!n&&t.parent&&cn(t,"onRepeat"),(e>=t._tDur||e<0)&&t.ratio===a&&(a&&Ai(t,1),!n&&!Be&&(cn(t,a?"onComplete":"onReverseComplete",!0),t._prom&&t._prom()))}else t._zTime||(t._zTime=e)},Mx=function(t,e,n){var i;if(n>e)for(i=t._first;i&&i._start<=n;){if(i.data==="isPause"&&i._start>e)return i;i=i._next}else for(i=t._last;i&&i._start>=n;){if(i.data==="isPause"&&i._start<e)return i;i=i._prev}},Hr=function(t,e,n,i){var s=t._repeat,a=Ae(e)||0,o=t._tTime/t._tDur;return o&&!i&&(t._time*=a/t._dur),t._dur=a,t._tDur=s?s<0?1e10:Ae(a*(s+1)+t._rDelay*s):a,o>0&&!i&&ja(t,t._tTime=t._tDur*o),t.parent&&Za(t),n||Yi(t.parent,t),t},Kh=function(t){return t instanceof Ve?Yi(t):Hr(t,t._dur)},Sx={_start:0,endTime:ys,totalDuration:ys},mn=function r(t,e,n){var i=t.labels,s=t._recent||Sx,a=t.duration()>=xn?s.endTime(!1):t._dur,o,l,c;return we(e)&&(isNaN(e)||e in i)?(l=e.charAt(0),c=e.substr(-1)==="%",o=e.indexOf("="),l==="<"||l===">"?(o>=0&&(e=e.replace(/=/,"")),(l==="<"?s._start:s.endTime(s._repeat>=0))+(parseFloat(e.substr(1))||0)*(c?(o<0?s:n).totalDuration()/100:1)):o<0?(e in i||(i[e]=a),i[e]):(l=parseFloat(e.charAt(o-1)+e.substr(o+1)),c&&n&&(l=l/100*(ze(n)?n[0]:n).totalDuration()),o>1?r(t,e.substr(0,o-1),n)+l:a+l)):e==null?a:+e},ps=function(t,e,n){var i=ri(e[1]),s=(i?2:1)+(t<2?0:1),a=e[s],o,l;if(i&&(a.duration=e[1]),a.parent=n,t){for(o=a,l=n;l&&!("immediateRender"in o);)o=l.vars.defaults||{},l=$e(l.vars.inherit)&&l.parent;a.immediateRender=$e(o.immediateRender),t<2?a.runBackwards=1:a.startAt=e[s-1]}return new Me(e[0],a,e[s+1])},Ri=function(t,e){return t||t===0?e(t):e},Us=function(t,e,n){return n<t?t:n>e?e:n},Oe=function(t,e){return!we(t)||!(e=hx.exec(t))?"":e[1]},yx=function(t,e,n){return Ri(n,function(i){return Us(t,e,i)})},Ll=[].slice,cf=function(t,e){return t&&kn(t)&&"length"in t&&(!e&&!t.length||t.length-1 in t&&kn(t[0]))&&!t.nodeType&&t!==Ln},Ex=function(t,e,n){return n===void 0&&(n=[]),t.forEach(function(i){var s;return we(i)&&!e||cf(i,1)?(s=n).push.apply(s,Mn(i)):n.push(i)})||n},Mn=function(t,e,n){return ae&&!e&&ae.selector?ae.selector(t):we(t)&&!n&&(Rl||!Vr())?Ll.call((e||cc).querySelectorAll(t),0):ze(t)?Ex(t,n):cf(t)?Ll.call(t,0):t?[t]:[]},Ul=function(t){return t=Mn(t)[0]||Ss("Invalid scope")||{},function(e){var n=t.current||t.nativeElement||t;return Mn(e,n.querySelectorAll?n:n===t?Ss("Invalid scope")||cc.createElement("div"):t)}},hf=function(t){return t.sort(function(){return .5-Math.random()})},uf=function(t){if(pe(t))return t;var e=kn(t)?t:{each:t},n=qi(e.ease),i=e.from||0,s=parseFloat(e.base)||0,a={},o=i>0&&i<1,l=isNaN(i)||o,c=e.axis,h=i,u=i;return we(i)?h=u={center:.5,edges:.5,end:1}[i]||0:!o&&l&&(h=i[0],u=i[1]),function(f,p,g){var _=(g||e).length,m=a[_],d,T,E,x,R,w,b,C,v;if(!m){if(v=e.grid==="auto"?0:(e.grid||[1,xn])[1],!v){for(b=-xn;b<(b=g[v++].getBoundingClientRect().left)&&v<_;);v<_&&v--}for(m=a[_]=[],d=l?Math.min(v,_)*h-.5:i%v,T=v===xn?0:l?_*u/v-.5:i/v|0,b=0,C=xn,w=0;w<_;w++)E=w%v-d,x=T-(w/v|0),m[w]=R=c?Math.abs(c==="y"?x:E):Xu(E*E+x*x),R>b&&(b=R),R<C&&(C=R);i==="random"&&hf(m),m.max=b-C,m.min=C,m.v=_=(parseFloat(e.amount)||parseFloat(e.each)*(v>_?_-1:c?c==="y"?_/v:v:Math.max(v,_/v))||0)*(i==="edges"?-1:1),m.b=_<0?s-_:s,m.u=Oe(e.amount||e.each)||0,n=n&&_<0?Sf(n):n}return _=(m[f]-m.min)/m.max||0,Ae(m.b+(n?n(_):_)*m.v)+m.u}},Il=function(t){var e=Math.pow(10,((t+"").split(".")[1]||"").length);return function(n){var i=Ae(Math.round(parseFloat(n)/t)*t*e);return(i-i%1)/e+(ri(n)?0:Oe(n))}},ff=function(t,e){var n=ze(t),i,s;return!n&&kn(t)&&(i=n=t.radius||xn,t.values?(t=Mn(t.values),(s=!ri(t[0]))&&(i*=i)):t=Il(t.increment)),Ri(e,n?pe(t)?function(a){return s=t(a),Math.abs(s-a)<=i?s:a}:function(a){for(var o=parseFloat(s?a.x:a),l=parseFloat(s?a.y:0),c=xn,h=0,u=t.length,f,p;u--;)s?(f=t[u].x-o,p=t[u].y-l,f=f*f+p*p):f=Math.abs(t[u]-o),f<c&&(c=f,h=u);return h=!i||c<=i?t[h]:a,s||h===a||ri(a)?h:h+Oe(a)}:Il(t))},df=function(t,e,n,i){return Ri(ze(t)?!e:n===!0?!!(n=0):!i,function(){return ze(t)?t[~~(Math.random()*t.length)]:(n=n||1e-5)&&(i=n<1?Math.pow(10,(n+"").length-2):1)&&Math.floor(Math.round((t-n/2+Math.random()*(e-t+n*.99))/n)*n*i)/i})},Tx=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];return function(i){return e.reduce(function(s,a){return a(s)},i)}},bx=function(t,e){return function(n){return t(parseFloat(n))+(e||Oe(n))}},Ax=function(t,e,n){return mf(t,e,0,1,n)},pf=function(t,e,n){return Ri(n,function(i){return t[~~e(i)]})},wx=function r(t,e,n){var i=e-t;return ze(t)?pf(t,r(0,t.length),e):Ri(n,function(s){return(i+(s-t)%i)%i+t})},Rx=function r(t,e,n){var i=e-t,s=i*2;return ze(t)?pf(t,r(0,t.length-1),e):Ri(n,function(a){return a=(s+(a-t)%s)%s||0,t+(a>i?s-a:a)})},Es=function(t){for(var e=0,n="",i,s,a,o;~(i=t.indexOf("random(",e));)a=t.indexOf(")",i),o=t.charAt(i+7)==="[",s=t.substr(i+7,a-i-7).match(o?ju:wl),n+=t.substr(e,i-e)+df(o?s:+s[0],o?0:+s[1],+s[2]||1e-5),e=a+1;return n+t.substr(e,t.length-e)},mf=function(t,e,n,i,s){var a=e-t,o=i-n;return Ri(s,function(l){return n+((l-t)/a*o||0)})},Cx=function r(t,e,n,i){var s=isNaN(t+e)?0:function(p){return(1-p)*t+p*e};if(!s){var a=we(t),o={},l,c,h,u,f;if(n===!0&&(i=1)&&(n=null),a)t={p:t},e={p:e};else if(ze(t)&&!ze(e)){for(h=[],u=t.length,f=u-2,c=1;c<u;c++)h.push(r(t[c-1],t[c]));u--,s=function(g){g*=u;var _=Math.min(f,~~g);return h[_](g-_)},n=e}else i||(t=Ji(ze(t)?[]:{},t));if(!h){for(l in e)pc.call(o,t,l,"get",e[l]);s=function(g){return vc(g,o)||(a?t.p:t)}}}return Ri(n,s)},$h=function(t,e,n){var i=t.labels,s=xn,a,o,l;for(a in i)o=i[a]-e,o<0==!!n&&o&&s>(o=Math.abs(o))&&(l=a,s=o);return l},cn=function(t,e,n){var i=t.vars,s=i[e],a=ae,o=t._ctx,l,c,h;if(s)return l=i[e+"Params"],c=i.callbackScope||t,n&&yi.length&&Ca(),o&&(ae=o),h=l?s.apply(c,l):s.call(c),ae=a,h},hs=function(t){return Ai(t),t.scrollTrigger&&t.scrollTrigger.kill(!!Be),t.progress()<1&&cn(t,"onInterrupt"),t},Er,_f=[],gf=function(t){if(t)if(t=!t.name&&t.default||t,lc()||t.headless){var e=t.name,n=pe(t),i=e&&!n&&t.init?function(){this._props=[]}:t,s={init:ys,render:vc,add:pc,kill:Xx,modifier:Wx,rawVars:0},a={targetTest:0,get:0,getSetter:gc,aliases:{},register:0};if(Vr(),t!==i){if(an[e])return;Sn(i,Sn(Pa(t,s),a)),Ji(i.prototype,Ji(s,Pa(t,a))),an[i.prop=e]=i,t.targetTest&&(Ma.push(i),uc[e]=1),e=(e==="css"?"CSS":e.charAt(0).toUpperCase()+e.substr(1))+"Plugin"}Ju(e,i),t.register&&t.register(en,i,Qe)}else _f.push(t)},Qt=255,us={aqua:[0,Qt,Qt],lime:[0,Qt,0],silver:[192,192,192],black:[0,0,0],maroon:[128,0,0],teal:[0,128,128],blue:[0,0,Qt],navy:[0,0,128],white:[Qt,Qt,Qt],olive:[128,128,0],yellow:[Qt,Qt,0],orange:[Qt,165,0],gray:[128,128,128],purple:[128,0,128],green:[0,128,0],red:[Qt,0,0],pink:[Qt,192,203],cyan:[0,Qt,Qt],transparent:[Qt,Qt,Qt,0]},Uo=function(t,e,n){return t+=t<0?1:t>1?-1:0,(t*6<1?e+(n-e)*t*6:t<.5?n:t*3<2?e+(n-e)*(2/3-t)*6:e)*Qt+.5|0},vf=function(t,e,n){var i=t?ri(t)?[t>>16,t>>8&Qt,t&Qt]:0:us.black,s,a,o,l,c,h,u,f,p,g;if(!i){if(t.substr(-1)===","&&(t=t.substr(0,t.length-1)),us[t])i=us[t];else if(t.charAt(0)==="#"){if(t.length<6&&(s=t.charAt(1),a=t.charAt(2),o=t.charAt(3),t="#"+s+s+a+a+o+o+(t.length===5?t.charAt(4)+t.charAt(4):"")),t.length===9)return i=parseInt(t.substr(1,6),16),[i>>16,i>>8&Qt,i&Qt,parseInt(t.substr(7),16)/255];t=parseInt(t.substr(1),16),i=[t>>16,t>>8&Qt,t&Qt]}else if(t.substr(0,3)==="hsl"){if(i=g=t.match(wl),!e)l=+i[0]%360/360,c=+i[1]/100,h=+i[2]/100,a=h<=.5?h*(c+1):h+c-h*c,s=h*2-a,i.length>3&&(i[3]*=1),i[0]=Uo(l+1/3,s,a),i[1]=Uo(l,s,a),i[2]=Uo(l-1/3,s,a);else if(~t.indexOf("="))return i=t.match(qu),n&&i.length<4&&(i[3]=1),i}else i=t.match(wl)||us.transparent;i=i.map(Number)}return e&&!g&&(s=i[0]/Qt,a=i[1]/Qt,o=i[2]/Qt,u=Math.max(s,a,o),f=Math.min(s,a,o),h=(u+f)/2,u===f?l=c=0:(p=u-f,c=h>.5?p/(2-u-f):p/(u+f),l=u===s?(a-o)/p+(a<o?6:0):u===a?(o-s)/p+2:(s-a)/p+4,l*=60),i[0]=~~(l+.5),i[1]=~~(c*100+.5),i[2]=~~(h*100+.5)),n&&i.length<4&&(i[3]=1),i},xf=function(t){var e=[],n=[],i=-1;return t.split(Ei).forEach(function(s){var a=s.match(yr)||[];e.push.apply(e,a),n.push(i+=a.length+1)}),e.c=n,e},Jh=function(t,e,n){var i="",s=(t+i).match(Ei),a=e?"hsla(":"rgba(",o=0,l,c,h,u;if(!s)return t;if(s=s.map(function(f){return(f=vf(f,e,1))&&a+(e?f[0]+","+f[1]+"%,"+f[2]+"%,"+f[3]:f.join(","))+")"}),n&&(h=xf(t),l=n.c,l.join(i)!==h.c.join(i)))for(c=t.replace(Ei,"1").split(yr),u=c.length-1;o<u;o++)i+=c[o]+(~l.indexOf(o)?s.shift()||a+"0,0,0,0)":(h.length?h:s.length?s:n).shift());if(!c)for(c=t.split(Ei),u=c.length-1;o<u;o++)i+=c[o]+s[o];return i+c[u]},Ei=function(){var r="(?:\\b(?:(?:rgb|rgba|hsl|hsla)\\(.+?\\))|\\B#(?:[0-9a-f]{3,4}){1,2}\\b",t;for(t in us)r+="|"+t+"\\b";return new RegExp(r+")","gi")}(),Px=/hsl[a]?\(/,Mf=function(t){var e=t.join(" "),n;if(Ei.lastIndex=0,Ei.test(e))return n=Px.test(e),t[1]=Jh(t[1],n),t[0]=Jh(t[0],n,xf(t[1])),!0},Ts,on=function(){var r=Date.now,t=500,e=33,n=r(),i=n,s=1e3/240,a=s,o=[],l,c,h,u,f,p,g=function _(m){var d=r()-i,T=m===!0,E,x,R,w;if((d>t||d<0)&&(n+=d-e),i+=d,R=i-n,E=R-a,(E>0||T)&&(w=++u.frame,f=R-u.time*1e3,u.time=R=R/1e3,a+=E+(E>=s?4:s-E),x=1),T||(l=c(_)),x)for(p=0;p<o.length;p++)o[p](R,f,w,m)};return u={time:0,frame:0,tick:function(){g(!0)},deltaRatio:function(m){return f/(1e3/(m||60))},wake:function(){Ku&&(!Rl&&lc()&&(Ln=Rl=window,cc=Ln.document||{},un.gsap=en,(Ln.gsapVersions||(Ln.gsapVersions=[])).push(en.version),$u(Ra||Ln.GreenSockGlobals||!Ln.gsap&&Ln||{}),_f.forEach(gf)),h=typeof requestAnimationFrame<"u"&&requestAnimationFrame,l&&u.sleep(),c=h||function(m){return setTimeout(m,a-u.time*1e3+1|0)},Ts=1,g(2))},sleep:function(){(h?cancelAnimationFrame:clearTimeout)(l),Ts=0,c=ys},lagSmoothing:function(m,d){t=m||1/0,e=Math.min(d||33,t)},fps:function(m){s=1e3/(m||240),a=u.time*1e3+s},add:function(m,d,T){var E=d?function(x,R,w,b){m(x,R,w,b),u.remove(E)}:m;return u.remove(m),o[T?"unshift":"push"](E),Vr(),E},remove:function(m,d){~(d=o.indexOf(m))&&o.splice(d,1)&&p>=d&&p--},_listeners:o},u}(),Vr=function(){return!Ts&&on.wake()},Ot={},Dx=/^[\d.\-M][\d.\-,\s]/,Lx=/["']/g,Ux=function(t){for(var e={},n=t.substr(1,t.length-3).split(":"),i=n[0],s=1,a=n.length,o,l,c;s<a;s++)l=n[s],o=s!==a-1?l.lastIndexOf(","):l.length,c=l.substr(0,o),e[i]=isNaN(c)?c.replace(Lx,"").trim():+c,i=l.substr(o+1).trim();return e},Ix=function(t){var e=t.indexOf("(")+1,n=t.indexOf(")"),i=t.indexOf("(",e);return t.substring(e,~i&&i<n?t.indexOf(")",n+1):n)},Nx=function(t){var e=(t+"").split("("),n=Ot[e[0]];return n&&e.length>1&&n.config?n.config.apply(null,~t.indexOf("{")?[Ux(e[1])]:Ix(t).split(",").map(nf)):Ot._CE&&Dx.test(t)?Ot._CE("",t):n},Sf=function(t){return function(e){return 1-t(1-e)}},yf=function r(t,e){for(var n=t._first,i;n;)n instanceof Ve?r(n,e):n.vars.yoyoEase&&(!n._yoyo||!n._repeat)&&n._yoyo!==e&&(n.timeline?r(n.timeline,e):(i=n._ease,n._ease=n._yEase,n._yEase=i,n._yoyo=e)),n=n._next},qi=function(t,e){return t&&(pe(t)?t:Ot[t]||Nx(t))||e},nr=function(t,e,n,i){n===void 0&&(n=function(l){return 1-e(1-l)}),i===void 0&&(i=function(l){return l<.5?e(l*2)/2:1-e((1-l)*2)/2});var s={easeIn:e,easeOut:n,easeInOut:i},a;return Je(t,function(o){Ot[o]=un[o]=s,Ot[a=o.toLowerCase()]=n;for(var l in s)Ot[a+(l==="easeIn"?".in":l==="easeOut"?".out":".inOut")]=Ot[o+"."+l]=s[l]}),s},Ef=function(t){return function(e){return e<.5?(1-t(1-e*2))/2:.5+t((e-.5)*2)/2}},Io=function r(t,e,n){var i=e>=1?e:1,s=(n||(t?.3:.45))/(e<1?e:1),a=s/Al*(Math.asin(1/i)||0),o=function(h){return h===1?1:i*Math.pow(2,-10*h)*cx((h-a)*s)+1},l=t==="out"?o:t==="in"?function(c){return 1-o(1-c)}:Ef(o);return s=Al/s,l.config=function(c,h){return r(t,c,h)},l},No=function r(t,e){e===void 0&&(e=1.70158);var n=function(a){return a?--a*a*((e+1)*a+e)+1:0},i=t==="out"?n:t==="in"?function(s){return 1-n(1-s)}:Ef(n);return i.config=function(s){return r(t,s)},i};Je("Linear,Quad,Cubic,Quart,Quint,Strong",function(r,t){var e=t<5?t+1:t;nr(r+",Power"+(e-1),t?function(n){return Math.pow(n,e)}:function(n){return n},function(n){return 1-Math.pow(1-n,e)},function(n){return n<.5?Math.pow(n*2,e)/2:1-Math.pow((1-n)*2,e)/2})});Ot.Linear.easeNone=Ot.none=Ot.Linear.easeIn;nr("Elastic",Io("in"),Io("out"),Io());(function(r,t){var e=1/t,n=2*e,i=2.5*e,s=function(o){return o<e?r*o*o:o<n?r*Math.pow(o-1.5/t,2)+.75:o<i?r*(o-=2.25/t)*o+.9375:r*Math.pow(o-2.625/t,2)+.984375};nr("Bounce",function(a){return 1-s(1-a)},s)})(7.5625,2.75);nr("Expo",function(r){return r?Math.pow(2,10*(r-1)):0});nr("Circ",function(r){return-(Xu(1-r*r)-1)});nr("Sine",function(r){return r===1?1:-lx(r*ax)+1});nr("Back",No("in"),No("out"),No());Ot.SteppedEase=Ot.steps=un.SteppedEase={config:function(t,e){t===void 0&&(t=1);var n=1/t,i=t+(e?0:1),s=e?1:0,a=1-ne;return function(o){return((i*Us(0,a,o)|0)+s)*n}}};zr.ease=Ot["quad.out"];Je("onComplete,onUpdate,onStart,onRepeat,onReverseComplete,onInterrupt",function(r){return fc+=r+","+r+"Params,"});var Tf=function(t,e){this.id=ox++,t._gsap=this,this.target=t,this.harness=e,this.get=e?e.get:tf,this.set=e?e.getSetter:gc},bs=function(){function r(e){this.vars=e,this._delay=+e.delay||0,(this._repeat=e.repeat===1/0?-2:e.repeat||0)&&(this._rDelay=e.repeatDelay||0,this._yoyo=!!e.yoyo||!!e.yoyoEase),this._ts=1,Hr(this,+e.duration,1,1),this.data=e.data,ae&&(this._ctx=ae,ae.data.push(this)),Ts||on.wake()}var t=r.prototype;return t.delay=function(n){return n||n===0?(this.parent&&this.parent.smoothChildTiming&&this.startTime(this._start+n-this._delay),this._delay=n,this):this._delay},t.duration=function(n){return arguments.length?this.totalDuration(this._repeat>0?n+(n+this._rDelay)*this._repeat:n):this.totalDuration()&&this._dur},t.totalDuration=function(n){return arguments.length?(this._dirty=0,Hr(this,this._repeat<0?n:(n-this._repeat*this._rDelay)/(this._repeat+1))):this._tDur},t.totalTime=function(n,i){if(Vr(),!arguments.length)return this._tTime;var s=this._dp;if(s&&s.smoothChildTiming&&this._ts){for(ja(this,n),!s._dp||s.parent||af(s,this);s&&s.parent;)s.parent._time!==s._start+(s._ts>=0?s._tTime/s._ts:(s.totalDuration()-s._tTime)/-s._ts)&&s.totalTime(s._tTime,!0),s=s.parent;!this.parent&&this._dp.autoRemoveChildren&&(this._ts>0&&n<this._tDur||this._ts<0&&n>0||!this._tDur&&!n)&&In(this._dp,this,this._start-this._delay)}return(this._tTime!==n||!this._dur&&!i||this._initted&&Math.abs(this._zTime)===ne||!n&&!this._initted&&(this.add||this._ptLookup))&&(this._ts||(this._pTime=n),ef(this,n,i)),this},t.time=function(n,i){return arguments.length?this.totalTime(Math.min(this.totalDuration(),n+jh(this))%(this._dur+this._rDelay)||(n?this._dur:0),i):this._time},t.totalProgress=function(n,i){return arguments.length?this.totalTime(this.totalDuration()*n,i):this.totalDuration()?Math.min(1,this._tTime/this._tDur):this.rawTime()>0?1:0},t.progress=function(n,i){return arguments.length?this.totalTime(this.duration()*(this._yoyo&&!(this.iteration()&1)?1-n:n)+jh(this),i):this.duration()?Math.min(1,this._time/this._dur):this.rawTime()>0?1:0},t.iteration=function(n,i){var s=this.duration()+this._rDelay;return arguments.length?this.totalTime(this._time+(n-1)*s,i):this._repeat?kr(this._tTime,s)+1:1},t.timeScale=function(n,i){if(!arguments.length)return this._rts===-ne?0:this._rts;if(this._rts===n)return this;var s=this.parent&&this._ts?Da(this.parent._time,this):this._tTime;return this._rts=+n||0,this._ts=this._ps||n===-ne?0:this._rts,this.totalTime(Us(-Math.abs(this._delay),this._tDur,s),i!==!1),Za(this),_x(this)},t.paused=function(n){return arguments.length?(this._ps!==n&&(this._ps=n,n?(this._pTime=this._tTime||Math.max(-this._delay,this.rawTime()),this._ts=this._act=0):(Vr(),this._ts=this._rts,this.totalTime(this.parent&&!this.parent.smoothChildTiming?this.rawTime():this._tTime||this._pTime,this.progress()===1&&Math.abs(this._zTime)!==ne&&(this._tTime-=ne)))),this):this._ps},t.startTime=function(n){if(arguments.length){this._start=n;var i=this.parent||this._dp;return i&&(i._sort||!this.parent)&&In(i,this,n-this._delay),this}return this._start},t.endTime=function(n){return this._start+($e(n)?this.totalDuration():this.duration())/Math.abs(this._ts||1)},t.rawTime=function(n){var i=this.parent||this._dp;return i?n&&(!this._ts||this._repeat&&this._time&&this.totalProgress()<1)?this._tTime%(this._dur+this._rDelay):this._ts?Da(i.rawTime(n),this):this._tTime:this._tTime},t.revert=function(n){n===void 0&&(n=fx);var i=Be;return Be=n,(this._initted||this._startAt)&&(this.timeline&&this.timeline.revert(n),this.totalTime(-.01,n.suppressEvents)),this.data!=="nested"&&n.kill!==!1&&this.kill(),Be=i,this},t.globalTime=function(n){for(var i=this,s=arguments.length?n:i.rawTime();i;)s=i._start+s/(Math.abs(i._ts)||1),i=i._dp;return!this.parent&&this._sat?this._sat.globalTime(n):s},t.repeat=function(n){return arguments.length?(this._repeat=n===1/0?-2:n,Kh(this)):this._repeat===-2?1/0:this._repeat},t.repeatDelay=function(n){if(arguments.length){var i=this._time;return this._rDelay=n,Kh(this),i?this.time(i):this}return this._rDelay},t.yoyo=function(n){return arguments.length?(this._yoyo=n,this):this._yoyo},t.seek=function(n,i){return this.totalTime(mn(this,n),$e(i))},t.restart=function(n,i){return this.play().totalTime(n?-this._delay:0,$e(i))},t.play=function(n,i){return n!=null&&this.seek(n,i),this.reversed(!1).paused(!1)},t.reverse=function(n,i){return n!=null&&this.seek(n||this.totalDuration(),i),this.reversed(!0).paused(!1)},t.pause=function(n,i){return n!=null&&this.seek(n,i),this.paused(!0)},t.resume=function(){return this.paused(!1)},t.reversed=function(n){return arguments.length?(!!n!==this.reversed()&&this.timeScale(-this._rts||(n?-ne:0)),this):this._rts<0},t.invalidate=function(){return this._initted=this._act=0,this._zTime=-ne,this},t.isActive=function(){var n=this.parent||this._dp,i=this._start,s;return!!(!n||this._ts&&this._initted&&n.isActive()&&(s=n.rawTime(!0))>=i&&s<this.endTime(!0)-ne)},t.eventCallback=function(n,i,s){var a=this.vars;return arguments.length>1?(i?(a[n]=i,s&&(a[n+"Params"]=s),n==="onUpdate"&&(this._onUpdate=i)):delete a[n],this):a[n]},t.then=function(n){var i=this;return new Promise(function(s){var a=pe(n)?n:rf,o=function(){var c=i.then;i.then=null,pe(a)&&(a=a(i))&&(a.then||a===i)&&(i.then=c),s(a),i.then=c};i._initted&&i.totalProgress()===1&&i._ts>=0||!i._tTime&&i._ts<0?o():i._prom=o})},t.kill=function(){hs(this)},r}();Sn(bs.prototype,{_time:0,_start:0,_end:0,_tTime:0,_tDur:0,_dirty:0,_repeat:0,_yoyo:!1,parent:null,_initted:!1,_rDelay:0,_ts:1,_dp:0,ratio:0,_zTime:-ne,_prom:0,_ps:!1,_rts:1});var Ve=function(r){Wu(t,r);function t(n,i){var s;return n===void 0&&(n={}),s=r.call(this,n)||this,s.labels={},s.smoothChildTiming=!!n.smoothChildTiming,s.autoRemoveChildren=!!n.autoRemoveChildren,s._sort=$e(n.sortChildren),ce&&In(n.parent||ce,jn(s),i),n.reversed&&s.reverse(),n.paused&&s.paused(!0),n.scrollTrigger&&of(jn(s),n.scrollTrigger),s}var e=t.prototype;return e.to=function(i,s,a){return ps(0,arguments,this),this},e.from=function(i,s,a){return ps(1,arguments,this),this},e.fromTo=function(i,s,a,o){return ps(2,arguments,this),this},e.set=function(i,s,a){return s.duration=0,s.parent=this,ds(s).repeatDelay||(s.repeat=0),s.immediateRender=!!s.immediateRender,new Me(i,s,mn(this,a),1),this},e.call=function(i,s,a){return In(this,Me.delayedCall(0,i,s),a)},e.staggerTo=function(i,s,a,o,l,c,h){return a.duration=s,a.stagger=a.stagger||o,a.onComplete=c,a.onCompleteParams=h,a.parent=this,new Me(i,a,mn(this,l)),this},e.staggerFrom=function(i,s,a,o,l,c,h){return a.runBackwards=1,ds(a).immediateRender=$e(a.immediateRender),this.staggerTo(i,s,a,o,l,c,h)},e.staggerFromTo=function(i,s,a,o,l,c,h,u){return o.startAt=a,ds(o).immediateRender=$e(o.immediateRender),this.staggerTo(i,s,o,l,c,h,u)},e.render=function(i,s,a){var o=this._time,l=this._dirty?this.totalDuration():this._tDur,c=this._dur,h=i<=0?0:Ae(i),u=this._zTime<0!=i<0&&(this._initted||!c),f,p,g,_,m,d,T,E,x,R,w,b;if(this!==ce&&h>l&&i>=0&&(h=l),h!==this._tTime||a||u){if(o!==this._time&&c&&(h+=this._time-o,i+=this._time-o),f=h,x=this._start,E=this._ts,d=!E,u&&(c||(o=this._zTime),(i||!s)&&(this._zTime=i)),this._repeat){if(w=this._yoyo,m=c+this._rDelay,this._repeat<-1&&i<0)return this.totalTime(m*100+i,s,a);if(f=Ae(h%m),h===l?(_=this._repeat,f=c):(_=~~(h/m),_&&_===h/m&&(f=c,_--),f>c&&(f=c)),R=kr(this._tTime,m),!o&&this._tTime&&R!==_&&this._tTime-R*m-this._dur<=0&&(R=_),w&&_&1&&(f=c-f,b=1),_!==R&&!this._lock){var C=w&&R&1,v=C===(w&&_&1);if(_<R&&(C=!C),o=C?0:h%c?c:h,this._lock=1,this.render(o||(b?0:Ae(_*m)),s,!c)._lock=0,this._tTime=h,!s&&this.parent&&cn(this,"onRepeat"),this.vars.repeatRefresh&&!b&&(this.invalidate()._lock=1),o&&o!==this._time||d!==!this._ts||this.vars.onRepeat&&!this.parent&&!this._act)return this;if(c=this._dur,l=this._tDur,v&&(this._lock=2,o=C?c:-1e-4,this.render(o,!0),this.vars.repeatRefresh&&!b&&this.invalidate()),this._lock=0,!this._ts&&!d)return this;yf(this,b)}}if(this._hasPause&&!this._forcing&&this._lock<2&&(T=Mx(this,Ae(o),Ae(f)),T&&(h-=f-(f=T._start))),this._tTime=h,this._time=f,this._act=!E,this._initted||(this._onUpdate=this.vars.onUpdate,this._initted=1,this._zTime=i,o=0),!o&&f&&!s&&!_&&(cn(this,"onStart"),this._tTime!==h))return this;if(f>=o&&i>=0)for(p=this._first;p;){if(g=p._next,(p._act||f>=p._start)&&p._ts&&T!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(f-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(f-p._start)*p._ts,s,a),f!==this._time||!this._ts&&!d){T=0,g&&(h+=this._zTime=-ne);break}}p=g}else{p=this._last;for(var S=i<0?i:f;p;){if(g=p._prev,(p._act||S<=p._end)&&p._ts&&T!==p){if(p.parent!==this)return this.render(i,s,a);if(p.render(p._ts>0?(S-p._start)*p._ts:(p._dirty?p.totalDuration():p._tDur)+(S-p._start)*p._ts,s,a||Be&&(p._initted||p._startAt)),f!==this._time||!this._ts&&!d){T=0,g&&(h+=this._zTime=S?-ne:ne);break}}p=g}}if(T&&!s&&(this.pause(),T.render(f>=o?0:-ne)._zTime=f>=o?1:-1,this._ts))return this._start=x,Za(this),this.render(i,s,a);this._onUpdate&&!s&&cn(this,"onUpdate",!0),(h===l&&this._tTime>=this.totalDuration()||!h&&o)&&(x===this._start||Math.abs(E)!==Math.abs(this._ts))&&(this._lock||((i||!c)&&(h===l&&this._ts>0||!h&&this._ts<0)&&Ai(this,1),!s&&!(i<0&&!o)&&(h||o||!l)&&(cn(this,h===l&&i>=0?"onComplete":"onReverseComplete",!0),this._prom&&!(h<l&&this.timeScale()>0)&&this._prom())))}return this},e.add=function(i,s){var a=this;if(ri(s)||(s=mn(this,s,i)),!(i instanceof bs)){if(ze(i))return i.forEach(function(o){return a.add(o,s)}),this;if(we(i))return this.addLabel(i,s);if(pe(i))i=Me.delayedCall(0,i);else return this}return this!==i?In(this,i,s):this},e.getChildren=function(i,s,a,o){i===void 0&&(i=!0),s===void 0&&(s=!0),a===void 0&&(a=!0),o===void 0&&(o=-xn);for(var l=[],c=this._first;c;)c._start>=o&&(c instanceof Me?s&&l.push(c):(a&&l.push(c),i&&l.push.apply(l,c.getChildren(!0,s,a)))),c=c._next;return l},e.getById=function(i){for(var s=this.getChildren(1,1,1),a=s.length;a--;)if(s[a].vars.id===i)return s[a]},e.remove=function(i){return we(i)?this.removeLabel(i):pe(i)?this.killTweensOf(i):(qa(this,i),i===this._recent&&(this._recent=this._last),Yi(this))},e.totalTime=function(i,s){return arguments.length?(this._forcing=1,!this._dp&&this._ts&&(this._start=Ae(on.time-(this._ts>0?i/this._ts:(this.totalDuration()-i)/-this._ts))),r.prototype.totalTime.call(this,i,s),this._forcing=0,this):this._tTime},e.addLabel=function(i,s){return this.labels[i]=mn(this,s),this},e.removeLabel=function(i){return delete this.labels[i],this},e.addPause=function(i,s,a){var o=Me.delayedCall(0,s||ys,a);return o.data="isPause",this._hasPause=1,In(this,o,mn(this,i))},e.removePause=function(i){var s=this._first;for(i=mn(this,i);s;)s._start===i&&s.data==="isPause"&&Ai(s),s=s._next},e.killTweensOf=function(i,s,a){for(var o=this.getTweensOf(i,a),l=o.length;l--;)gi!==o[l]&&o[l].kill(i,s);return this},e.getTweensOf=function(i,s){for(var a=[],o=Mn(i),l=this._first,c=ri(s),h;l;)l instanceof Me?dx(l._targets,o)&&(c?(!gi||l._initted&&l._ts)&&l.globalTime(0)<=s&&l.globalTime(l.totalDuration())>s:!s||l.isActive())&&a.push(l):(h=l.getTweensOf(o,s)).length&&a.push.apply(a,h),l=l._next;return a},e.tweenTo=function(i,s){s=s||{};var a=this,o=mn(a,i),l=s,c=l.startAt,h=l.onStart,u=l.onStartParams,f=l.immediateRender,p,g=Me.to(a,Sn({ease:s.ease||"none",lazy:!1,immediateRender:!1,time:o,overwrite:"auto",duration:s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale())||ne,onStart:function(){if(a.pause(),!p){var m=s.duration||Math.abs((o-(c&&"time"in c?c.time:a._time))/a.timeScale());g._dur!==m&&Hr(g,m,0,1).render(g._time,!0,!0),p=1}h&&h.apply(g,u||[])}},s));return f?g.render(0):g},e.tweenFromTo=function(i,s,a){return this.tweenTo(s,Sn({startAt:{time:mn(this,i)}},a))},e.recent=function(){return this._recent},e.nextLabel=function(i){return i===void 0&&(i=this._time),$h(this,mn(this,i))},e.previousLabel=function(i){return i===void 0&&(i=this._time),$h(this,mn(this,i),1)},e.currentLabel=function(i){return arguments.length?this.seek(i,!0):this.previousLabel(this._time+ne)},e.shiftChildren=function(i,s,a){a===void 0&&(a=0);for(var o=this._first,l=this.labels,c;o;)o._start>=a&&(o._start+=i,o._end+=i),o=o._next;if(s)for(c in l)l[c]>=a&&(l[c]+=i);return Yi(this)},e.invalidate=function(i){var s=this._first;for(this._lock=0;s;)s.invalidate(i),s=s._next;return r.prototype.invalidate.call(this,i)},e.clear=function(i){i===void 0&&(i=!0);for(var s=this._first,a;s;)a=s._next,this.remove(s),s=a;return this._dp&&(this._time=this._tTime=this._pTime=0),i&&(this.labels={}),Yi(this)},e.totalDuration=function(i){var s=0,a=this,o=a._last,l=xn,c,h,u;if(arguments.length)return a.timeScale((a._repeat<0?a.duration():a.totalDuration())/(a.reversed()?-i:i));if(a._dirty){for(u=a.parent;o;)c=o._prev,o._dirty&&o.totalDuration(),h=o._start,h>l&&a._sort&&o._ts&&!a._lock?(a._lock=1,In(a,o,h-o._delay,1)._lock=0):l=h,h<0&&o._ts&&(s-=h,(!u&&!a._dp||u&&u.smoothChildTiming)&&(a._start+=h/a._ts,a._time-=h,a._tTime-=h),a.shiftChildren(-h,!1,-1/0),l=0),o._end>s&&o._ts&&(s=o._end),o=c;Hr(a,a===ce&&a._time>s?a._time:s,1,1),a._dirty=0}return a._tDur},t.updateRoot=function(i){if(ce._ts&&(ef(ce,Da(i,ce)),Qu=on.frame),on.frame>=qh){qh+=hn.autoSleep||120;var s=ce._first;if((!s||!s._ts)&&hn.autoSleep&&on._listeners.length<2){for(;s&&!s._ts;)s=s._next;s||on.sleep()}}},t}(bs);Sn(Ve.prototype,{_lock:0,_hasPause:0,_forcing:0});var Ox=function(t,e,n,i,s,a,o){var l=new Qe(this._pt,t,e,0,1,Pf,null,s),c=0,h=0,u,f,p,g,_,m,d,T;for(l.b=n,l.e=i,n+="",i+="",(d=~i.indexOf("random("))&&(i=Es(i)),a&&(T=[n,i],a(T,t,e),n=T[0],i=T[1]),f=n.match(Do)||[];u=Do.exec(i);)g=u[0],_=i.substring(c,u.index),p?p=(p+1)%5:_.substr(-5)==="rgba("&&(p=1),g!==f[h++]&&(m=parseFloat(f[h-1])||0,l._pt={_next:l._pt,p:_||h===1?_:",",s:m,c:g.charAt(1)==="="?Cr(m,g)-m:parseFloat(g)-m,m:p&&p<4?Math.round:0},c=Do.lastIndex);return l.c=c<i.length?i.substring(c,i.length):"",l.fp=o,(Zu.test(i)||d)&&(l.e=0),this._pt=l,l},pc=function(t,e,n,i,s,a,o,l,c,h){pe(i)&&(i=i(s||0,t,a));var u=t[e],f=n!=="get"?n:pe(u)?c?t[e.indexOf("set")||!pe(t["get"+e.substr(3)])?e:"get"+e.substr(3)](c):t[e]():u,p=pe(u)?c?Hx:Rf:_c,g;if(we(i)&&(~i.indexOf("random(")&&(i=Es(i)),i.charAt(1)==="="&&(g=Cr(f,i)+(Oe(f)||0),(g||g===0)&&(i=g))),!h||f!==i||Nl)return!isNaN(f*i)&&i!==""?(g=new Qe(this._pt,t,e,+f||0,i-(f||0),typeof u=="boolean"?Gx:Cf,0,p),c&&(g.fp=c),o&&g.modifier(o,this,t),this._pt=g):(!u&&!(e in t)&&hc(e,i),Ox.call(this,t,e,f,i,p,l||hn.stringFilter,c))},Fx=function(t,e,n,i,s){if(pe(t)&&(t=ms(t,s,e,n,i)),!kn(t)||t.style&&t.nodeType||ze(t)||Yu(t))return we(t)?ms(t,s,e,n,i):t;var a={},o;for(o in t)a[o]=ms(t[o],s,e,n,i);return a},bf=function(t,e,n,i,s,a){var o,l,c,h;if(an[t]&&(o=new an[t]).init(s,o.rawVars?e[t]:Fx(e[t],i,s,a,n),n,i,a)!==!1&&(n._pt=l=new Qe(n._pt,s,t,0,1,o.render,o,0,o.priority),n!==Er))for(c=n._ptLookup[n._targets.indexOf(s)],h=o._props.length;h--;)c[o._props[h]]=l;return o},gi,Nl,mc=function r(t,e,n){var i=t.vars,s=i.ease,a=i.startAt,o=i.immediateRender,l=i.lazy,c=i.onUpdate,h=i.runBackwards,u=i.yoyoEase,f=i.keyframes,p=i.autoRevert,g=t._dur,_=t._startAt,m=t._targets,d=t.parent,T=d&&d.data==="nested"?d.vars.targets:m,E=t._overwrite==="auto"&&!ac,x=t.timeline,R,w,b,C,v,S,P,k,O,X,Y,V,q;if(x&&(!f||!s)&&(s="none"),t._ease=qi(s,zr.ease),t._yEase=u?Sf(qi(u===!0?s:u,zr.ease)):0,u&&t._yoyo&&!t._repeat&&(u=t._yEase,t._yEase=t._ease,t._ease=u),t._from=!x&&!!i.runBackwards,!x||f&&!i.stagger){if(k=m[0]?Xi(m[0]).harness:0,V=k&&i[k.prop],R=Pa(i,uc),_&&(_._zTime<0&&_.progress(1),e<0&&h&&o&&!p?_.render(-1,!0):_.revert(h&&g?xa:ux),_._lazy=0),a){if(Ai(t._startAt=Me.set(m,Sn({data:"isStart",overwrite:!1,parent:d,immediateRender:!0,lazy:!_&&$e(l),startAt:null,delay:0,onUpdate:c&&function(){return cn(t,"onUpdate")},stagger:0},a))),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Be||!o&&!p)&&t._startAt.revert(xa),o&&g&&e<=0&&n<=0){e&&(t._zTime=e);return}}else if(h&&g&&!_){if(e&&(o=!1),b=Sn({overwrite:!1,data:"isFromStart",lazy:o&&!_&&$e(l),immediateRender:o,stagger:0,parent:d},R),V&&(b[k.prop]=V),Ai(t._startAt=Me.set(m,b)),t._startAt._dp=0,t._startAt._sat=t,e<0&&(Be?t._startAt.revert(xa):t._startAt.render(-1,!0)),t._zTime=e,!o)r(t._startAt,ne,ne);else if(!e)return}for(t._pt=t._ptCache=0,l=g&&$e(l)||l&&!g,w=0;w<m.length;w++){if(v=m[w],P=v._gsap||dc(m)[w]._gsap,t._ptLookup[w]=X={},Cl[P.id]&&yi.length&&Ca(),Y=T===m?w:T.indexOf(v),k&&(O=new k).init(v,V||R,t,Y,T)!==!1&&(t._pt=C=new Qe(t._pt,v,O.name,0,1,O.render,O,0,O.priority),O._props.forEach(function(H){X[H]=C}),O.priority&&(S=1)),!k||V)for(b in R)an[b]&&(O=bf(b,R,t,Y,v,T))?O.priority&&(S=1):X[b]=C=pc.call(t,v,b,"get",R[b],Y,T,0,i.stringFilter);t._op&&t._op[w]&&t.kill(v,t._op[w]),E&&t._pt&&(gi=t,ce.killTweensOf(v,X,t.globalTime(e)),q=!t.parent,gi=0),t._pt&&l&&(Cl[P.id]=1)}S&&Df(t),t._onInit&&t._onInit(t)}t._onUpdate=c,t._initted=(!t._op||t._pt)&&!q,f&&e<=0&&x.render(xn,!0,!0)},Bx=function(t,e,n,i,s,a,o,l){var c=(t._pt&&t._ptCache||(t._ptCache={}))[e],h,u,f,p;if(!c)for(c=t._ptCache[e]=[],f=t._ptLookup,p=t._targets.length;p--;){if(h=f[p][e],h&&h.d&&h.d._pt)for(h=h.d._pt;h&&h.p!==e&&h.fp!==e;)h=h._next;if(!h)return Nl=1,t.vars[e]="+=0",mc(t,o),Nl=0,l?Ss(e+" not eligible for reset"):1;c.push(h)}for(p=c.length;p--;)u=c[p],h=u._pt||u,h.s=(i||i===0)&&!s?i:h.s+(i||0)+a*h.c,h.c=n-h.s,u.e&&(u.e=ge(n)+Oe(u.e)),u.b&&(u.b=h.s+Oe(u.b))},zx=function(t,e){var n=t[0]?Xi(t[0]).harness:0,i=n&&n.aliases,s,a,o,l;if(!i)return e;s=Ji({},e);for(a in i)if(a in s)for(l=i[a].split(","),o=l.length;o--;)s[l[o]]=s[a];return s},kx=function(t,e,n,i){var s=e.ease||i||"power1.inOut",a,o;if(ze(e))o=n[t]||(n[t]=[]),e.forEach(function(l,c){return o.push({t:c/(e.length-1)*100,v:l,e:s})});else for(a in e)o=n[a]||(n[a]=[]),a==="ease"||o.push({t:parseFloat(t),v:e[a],e:s})},ms=function(t,e,n,i,s){return pe(t)?t.call(e,n,i,s):we(t)&&~t.indexOf("random(")?Es(t):t},Af=fc+"repeat,repeatDelay,yoyo,repeatRefresh,yoyoEase,autoRevert",wf={};Je(Af+",id,stagger,delay,duration,paused,scrollTrigger",function(r){return wf[r]=1});var Me=function(r){Wu(t,r);function t(n,i,s,a){var o;typeof i=="number"&&(s.duration=i,i=s,s=null),o=r.call(this,a?i:ds(i))||this;var l=o.vars,c=l.duration,h=l.delay,u=l.immediateRender,f=l.stagger,p=l.overwrite,g=l.keyframes,_=l.defaults,m=l.scrollTrigger,d=l.yoyoEase,T=i.parent||ce,E=(ze(n)||Yu(n)?ri(n[0]):"length"in i)?[n]:Mn(n),x,R,w,b,C,v,S,P;if(o._targets=E.length?dc(E):Ss("GSAP target "+n+" not found. https://gsap.com",!hn.nullTargetWarn)||[],o._ptLookup=[],o._overwrite=p,g||f||ha(c)||ha(h)){if(i=o.vars,x=o.timeline=new Ve({data:"nested",defaults:_||{},targets:T&&T.data==="nested"?T.vars.targets:E}),x.kill(),x.parent=x._dp=jn(o),x._start=0,f||ha(c)||ha(h)){if(b=E.length,S=f&&uf(f),kn(f))for(C in f)~Af.indexOf(C)&&(P||(P={}),P[C]=f[C]);for(R=0;R<b;R++)w=Pa(i,wf),w.stagger=0,d&&(w.yoyoEase=d),P&&Ji(w,P),v=E[R],w.duration=+ms(c,jn(o),R,v,E),w.delay=(+ms(h,jn(o),R,v,E)||0)-o._delay,!f&&b===1&&w.delay&&(o._delay=h=w.delay,o._start+=h,w.delay=0),x.to(v,w,S?S(R,v,E):0),x._ease=Ot.none;x.duration()?c=h=0:o.timeline=0}else if(g){ds(Sn(x.vars.defaults,{ease:"none"})),x._ease=qi(g.ease||i.ease||"none");var k=0,O,X,Y;if(ze(g))g.forEach(function(V){return x.to(E,V,">")}),x.duration();else{w={};for(C in g)C==="ease"||C==="easeEach"||kx(C,g[C],w,g.easeEach);for(C in w)for(O=w[C].sort(function(V,q){return V.t-q.t}),k=0,R=0;R<O.length;R++)X=O[R],Y={ease:X.e,duration:(X.t-(R?O[R-1].t:0))/100*c},Y[C]=X.v,x.to(E,Y,k),k+=Y.duration;x.duration()<c&&x.to({},{duration:c-x.duration()})}}c||o.duration(c=x.duration())}else o.timeline=0;return p===!0&&!ac&&(gi=jn(o),ce.killTweensOf(E),gi=0),In(T,jn(o),s),i.reversed&&o.reverse(),i.paused&&o.paused(!0),(u||!c&&!g&&o._start===Ae(T._time)&&$e(u)&&gx(jn(o))&&T.data!=="nested")&&(o._tTime=-ne,o.render(Math.max(0,-h)||0)),m&&of(jn(o),m),o}var e=t.prototype;return e.render=function(i,s,a){var o=this._time,l=this._tDur,c=this._dur,h=i<0,u=i>l-ne&&!h?l:i<ne?0:i,f,p,g,_,m,d,T,E,x;if(!c)xx(this,i,s,a);else if(u!==this._tTime||!i||a||!this._initted&&this._tTime||this._startAt&&this._zTime<0!==h){if(f=u,E=this.timeline,this._repeat){if(_=c+this._rDelay,this._repeat<-1&&h)return this.totalTime(_*100+i,s,a);if(f=Ae(u%_),u===l?(g=this._repeat,f=c):(g=~~(u/_),g&&g===Ae(u/_)&&(f=c,g--),f>c&&(f=c)),d=this._yoyo&&g&1,d&&(x=this._yEase,f=c-f),m=kr(this._tTime,_),f===o&&!a&&this._initted&&g===m)return this._tTime=u,this;g!==m&&(E&&this._yEase&&yf(E,d),this.vars.repeatRefresh&&!d&&!this._lock&&this._time!==_&&this._initted&&(this._lock=a=1,this.render(Ae(_*g),!0).invalidate()._lock=0))}if(!this._initted){if(lf(this,h?i:f,a,s,u))return this._tTime=0,this;if(o!==this._time&&!(a&&this.vars.repeatRefresh&&g!==m))return this;if(c!==this._dur)return this.render(i,s,a)}if(this._tTime=u,this._time=f,!this._act&&this._ts&&(this._act=1,this._lazy=0),this.ratio=T=(x||this._ease)(f/c),this._from&&(this.ratio=T=1-T),f&&!o&&!s&&!g&&(cn(this,"onStart"),this._tTime!==u))return this;for(p=this._pt;p;)p.r(T,p.d),p=p._next;E&&E.render(i<0?i:E._dur*E._ease(f/this._dur),s,a)||this._startAt&&(this._zTime=i),this._onUpdate&&!s&&(h&&Pl(this,i,s,a),cn(this,"onUpdate")),this._repeat&&g!==m&&this.vars.onRepeat&&!s&&this.parent&&cn(this,"onRepeat"),(u===this._tDur||!u)&&this._tTime===u&&(h&&!this._onUpdate&&Pl(this,i,!0,!0),(i||!c)&&(u===this._tDur&&this._ts>0||!u&&this._ts<0)&&Ai(this,1),!s&&!(h&&!o)&&(u||o||d)&&(cn(this,u===l?"onComplete":"onReverseComplete",!0),this._prom&&!(u<l&&this.timeScale()>0)&&this._prom()))}return this},e.targets=function(){return this._targets},e.invalidate=function(i){return(!i||!this.vars.runBackwards)&&(this._startAt=0),this._pt=this._op=this._onUpdate=this._lazy=this.ratio=0,this._ptLookup=[],this.timeline&&this.timeline.invalidate(i),r.prototype.invalidate.call(this,i)},e.resetTo=function(i,s,a,o,l){Ts||on.wake(),this._ts||this.play();var c=Math.min(this._dur,(this._dp._time-this._start)*this._ts),h;return this._initted||mc(this,c),h=this._ease(c/this._dur),Bx(this,i,s,a,o,h,c,l)?this.resetTo(i,s,a,o,1):(ja(this,0),this.parent||sf(this._dp,this,"_first","_last",this._dp._sort?"_start":0),this.render(0))},e.kill=function(i,s){if(s===void 0&&(s="all"),!i&&(!s||s==="all"))return this._lazy=this._pt=0,this.parent?hs(this):this;if(this.timeline){var a=this.timeline.totalDuration();return this.timeline.killTweensOf(i,s,gi&&gi.vars.overwrite!==!0)._first||hs(this),this.parent&&a!==this.timeline.totalDuration()&&Hr(this,this._dur*this.timeline._tDur/a,0,1),this}var o=this._targets,l=i?Mn(i):o,c=this._ptLookup,h=this._pt,u,f,p,g,_,m,d;if((!s||s==="all")&&mx(o,l))return s==="all"&&(this._pt=0),hs(this);for(u=this._op=this._op||[],s!=="all"&&(we(s)&&(_={},Je(s,function(T){return _[T]=1}),s=_),s=zx(o,s)),d=o.length;d--;)if(~l.indexOf(o[d])){f=c[d],s==="all"?(u[d]=s,g=f,p={}):(p=u[d]=u[d]||{},g=s);for(_ in g)m=f&&f[_],m&&((!("kill"in m.d)||m.d.kill(_)===!0)&&qa(this,m,"_pt"),delete f[_]),p!=="all"&&(p[_]=1)}return this._initted&&!this._pt&&h&&hs(this),this},t.to=function(i,s){return new t(i,s,arguments[2])},t.from=function(i,s){return ps(1,arguments)},t.delayedCall=function(i,s,a,o){return new t(s,0,{immediateRender:!1,lazy:!1,overwrite:!1,delay:i,onComplete:s,onReverseComplete:s,onCompleteParams:a,onReverseCompleteParams:a,callbackScope:o})},t.fromTo=function(i,s,a){return ps(2,arguments)},t.set=function(i,s){return s.duration=0,s.repeatDelay||(s.repeat=0),new t(i,s)},t.killTweensOf=function(i,s,a){return ce.killTweensOf(i,s,a)},t}(bs);Sn(Me.prototype,{_targets:[],_lazy:0,_startAt:0,_op:0,_onInit:0});Je("staggerTo,staggerFrom,staggerFromTo",function(r){Me[r]=function(){var t=new Ve,e=Ll.call(arguments,0);return e.splice(r==="staggerFromTo"?5:4,0,0),t[r].apply(t,e)}});var _c=function(t,e,n){return t[e]=n},Rf=function(t,e,n){return t[e](n)},Hx=function(t,e,n,i){return t[e](i.fp,n)},Vx=function(t,e,n){return t.setAttribute(e,n)},gc=function(t,e){return pe(t[e])?Rf:oc(t[e])&&t.setAttribute?Vx:_c},Cf=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e6)/1e6,e)},Gx=function(t,e){return e.set(e.t,e.p,!!(e.s+e.c*t),e)},Pf=function(t,e){var n=e._pt,i="";if(!t&&e.b)i=e.b;else if(t===1&&e.e)i=e.e;else{for(;n;)i=n.p+(n.m?n.m(n.s+n.c*t):Math.round((n.s+n.c*t)*1e4)/1e4)+i,n=n._next;i+=e.c}e.set(e.t,e.p,i,e)},vc=function(t,e){for(var n=e._pt;n;)n.r(t,n.d),n=n._next},Wx=function(t,e,n,i){for(var s=this._pt,a;s;)a=s._next,s.p===i&&s.modifier(t,e,n),s=a},Xx=function(t){for(var e=this._pt,n,i;e;)i=e._next,e.p===t&&!e.op||e.op===t?qa(this,e,"_pt"):e.dep||(n=1),e=i;return!n},Yx=function(t,e,n,i){i.mSet(t,e,i.m.call(i.tween,n,i.mt),i)},Df=function(t){for(var e=t._pt,n,i,s,a;e;){for(n=e._next,i=s;i&&i.pr>e.pr;)i=i._next;(e._prev=i?i._prev:a)?e._prev._next=e:s=e,(e._next=i)?i._prev=e:a=e,e=n}t._pt=s},Qe=function(){function r(e,n,i,s,a,o,l,c,h){this.t=n,this.s=s,this.c=a,this.p=i,this.r=o||Cf,this.d=l||this,this.set=c||_c,this.pr=h||0,this._next=e,e&&(e._prev=this)}var t=r.prototype;return t.modifier=function(n,i,s){this.mSet=this.mSet||this.set,this.set=Yx,this.m=n,this.mt=s,this.tween=i},r}();Je(fc+"parent,duration,ease,delay,overwrite,runBackwards,startAt,yoyo,immediateRender,repeat,repeatDelay,data,paused,reversed,lazy,callbackScope,stringFilter,id,yoyoEase,stagger,inherit,repeatRefresh,keyframes,autoRevert,scrollTrigger",function(r){return uc[r]=1});un.TweenMax=un.TweenLite=Me;un.TimelineLite=un.TimelineMax=Ve;ce=new Ve({sortChildren:!1,defaults:zr,autoRemoveChildren:!0,id:"root",smoothChildTiming:!0});hn.stringFilter=Mf;var Zi=[],Sa={},qx=[],Qh=0,Zx=0,Oo=function(t){return(Sa[t]||qx).map(function(e){return e()})},Ol=function(){var t=Date.now(),e=[];t-Qh>2&&(Oo("matchMediaInit"),Zi.forEach(function(n){var i=n.queries,s=n.conditions,a,o,l,c;for(o in i)a=Ln.matchMedia(i[o]).matches,a&&(l=1),a!==s[o]&&(s[o]=a,c=1);c&&(n.revert(),l&&e.push(n))}),Oo("matchMediaRevert"),e.forEach(function(n){return n.onMatch(n,function(i){return n.add(null,i)})}),Qh=t,Oo("matchMedia"))},Lf=function(){function r(e,n){this.selector=n&&Ul(n),this.data=[],this._r=[],this.isReverted=!1,this.id=Zx++,e&&this.add(e)}var t=r.prototype;return t.add=function(n,i,s){pe(n)&&(s=i,i=n,n=pe);var a=this,o=function(){var c=ae,h=a.selector,u;return c&&c!==a&&c.data.push(a),s&&(a.selector=Ul(s)),ae=a,u=i.apply(a,arguments),pe(u)&&a._r.push(u),ae=c,a.selector=h,a.isReverted=!1,u};return a.last=o,n===pe?o(a,function(l){return a.add(null,l)}):n?a[n]=o:o},t.ignore=function(n){var i=ae;ae=null,n(this),ae=i},t.getTweens=function(){var n=[];return this.data.forEach(function(i){return i instanceof r?n.push.apply(n,i.getTweens()):i instanceof Me&&!(i.parent&&i.parent.data==="nested")&&n.push(i)}),n},t.clear=function(){this._r.length=this.data.length=0},t.kill=function(n,i){var s=this;if(n?function(){for(var o=s.getTweens(),l=s.data.length,c;l--;)c=s.data[l],c.data==="isFlip"&&(c.revert(),c.getChildren(!0,!0,!1).forEach(function(h){return o.splice(o.indexOf(h),1)}));for(o.map(function(h){return{g:h._dur||h._delay||h._sat&&!h._sat.vars.immediateRender?h.globalTime(0):-1/0,t:h}}).sort(function(h,u){return u.g-h.g||-1/0}).forEach(function(h){return h.t.revert(n)}),l=s.data.length;l--;)c=s.data[l],c instanceof Ve?c.data!=="nested"&&(c.scrollTrigger&&c.scrollTrigger.revert(),c.kill()):!(c instanceof Me)&&c.revert&&c.revert(n);s._r.forEach(function(h){return h(n,s)}),s.isReverted=!0}():this.data.forEach(function(o){return o.kill&&o.kill()}),this.clear(),i)for(var a=Zi.length;a--;)Zi[a].id===this.id&&Zi.splice(a,1)},t.revert=function(n){this.kill(n||{})},r}(),jx=function(){function r(e){this.contexts=[],this.scope=e,ae&&ae.data.push(this)}var t=r.prototype;return t.add=function(n,i,s){kn(n)||(n={matches:n});var a=new Lf(0,s||this.scope),o=a.conditions={},l,c,h;ae&&!a.selector&&(a.selector=ae.selector),this.contexts.push(a),i=a.add("onMatch",i),a.queries=n;for(c in n)c==="all"?h=1:(l=Ln.matchMedia(n[c]),l&&(Zi.indexOf(a)<0&&Zi.push(a),(o[c]=l.matches)&&(h=1),l.addListener?l.addListener(Ol):l.addEventListener("change",Ol)));return h&&i(a,function(u){return a.add(null,u)}),this},t.revert=function(n){this.kill(n||{})},t.kill=function(n){this.contexts.forEach(function(i){return i.kill(n,!0)})},r}(),La={registerPlugin:function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e.forEach(function(i){return gf(i)})},timeline:function(t){return new Ve(t)},getTweensOf:function(t,e){return ce.getTweensOf(t,e)},getProperty:function(t,e,n,i){we(t)&&(t=Mn(t)[0]);var s=Xi(t||{}).get,a=n?rf:nf;return n==="native"&&(n=""),t&&(e?a((an[e]&&an[e].get||s)(t,e,n,i)):function(o,l,c){return a((an[o]&&an[o].get||s)(t,o,l,c))})},quickSetter:function(t,e,n){if(t=Mn(t),t.length>1){var i=t.map(function(h){return en.quickSetter(h,e,n)}),s=i.length;return function(h){for(var u=s;u--;)i[u](h)}}t=t[0]||{};var a=an[e],o=Xi(t),l=o.harness&&(o.harness.aliases||{})[e]||e,c=a?function(h){var u=new a;Er._pt=0,u.init(t,n?h+n:h,Er,0,[t]),u.render(1,u),Er._pt&&vc(1,Er)}:o.set(t,l);return a?c:function(h){return c(t,l,n?h+n:h,o,1)}},quickTo:function(t,e,n){var i,s=en.to(t,Ji((i={},i[e]="+=0.1",i.paused=!0,i),n||{})),a=function(l,c,h){return s.resetTo(e,l,c,h)};return a.tween=s,a},isTweening:function(t){return ce.getTweensOf(t,!0).length>0},defaults:function(t){return t&&t.ease&&(t.ease=qi(t.ease,zr.ease)),Zh(zr,t||{})},config:function(t){return Zh(hn,t||{})},registerEffect:function(t){var e=t.name,n=t.effect,i=t.plugins,s=t.defaults,a=t.extendTimeline;(i||"").split(",").forEach(function(o){return o&&!an[o]&&!un[o]&&Ss(e+" effect requires "+o+" plugin.")}),Lo[e]=function(o,l,c){return n(Mn(o),Sn(l||{},s),c)},a&&(Ve.prototype[e]=function(o,l,c){return this.add(Lo[e](o,kn(l)?l:(c=l)&&{},this),c)})},registerEase:function(t,e){Ot[t]=qi(e)},parseEase:function(t,e){return arguments.length?qi(t,e):Ot},getById:function(t){return ce.getById(t)},exportRoot:function(t,e){t===void 0&&(t={});var n=new Ve(t),i,s;for(n.smoothChildTiming=$e(t.smoothChildTiming),ce.remove(n),n._dp=0,n._time=n._tTime=ce._time,i=ce._first;i;)s=i._next,(e||!(!i._dur&&i instanceof Me&&i.vars.onComplete===i._targets[0]))&&In(n,i,i._start-i._delay),i=s;return In(ce,n,0),n},context:function(t,e){return t?new Lf(t,e):ae},matchMedia:function(t){return new jx(t)},matchMediaRefresh:function(){return Zi.forEach(function(t){var e=t.conditions,n,i;for(i in e)e[i]&&(e[i]=!1,n=1);n&&t.revert()})||Ol()},addEventListener:function(t,e){var n=Sa[t]||(Sa[t]=[]);~n.indexOf(e)||n.push(e)},removeEventListener:function(t,e){var n=Sa[t],i=n&&n.indexOf(e);i>=0&&n.splice(i,1)},utils:{wrap:wx,wrapYoyo:Rx,distribute:uf,random:df,snap:ff,normalize:Ax,getUnit:Oe,clamp:yx,splitColor:vf,toArray:Mn,selector:Ul,mapRange:mf,pipe:Tx,unitize:bx,interpolate:Cx,shuffle:hf},install:$u,effects:Lo,ticker:on,updateRoot:Ve.updateRoot,plugins:an,globalTimeline:ce,core:{PropTween:Qe,globals:Ju,Tween:Me,Timeline:Ve,Animation:bs,getCache:Xi,_removeLinkedListItem:qa,reverting:function(){return Be},context:function(t){return t&&ae&&(ae.data.push(t),t._ctx=ae),ae},suppressOverwrites:function(t){return ac=t}}};Je("to,from,fromTo,delayedCall,set,killTweensOf",function(r){return La[r]=Me[r]});on.add(Ve.updateRoot);Er=La.to({},{duration:0});var Kx=function(t,e){for(var n=t._pt;n&&n.p!==e&&n.op!==e&&n.fp!==e;)n=n._next;return n},$x=function(t,e){var n=t._targets,i,s,a;for(i in e)for(s=n.length;s--;)a=t._ptLookup[s][i],a&&(a=a.d)&&(a._pt&&(a=Kx(a,i)),a&&a.modifier&&a.modifier(e[i],t,n[s],i))},Fo=function(t,e){return{name:t,rawVars:1,init:function(i,s,a){a._onInit=function(o){var l,c;if(we(s)&&(l={},Je(s,function(h){return l[h]=1}),s=l),e){l={};for(c in s)l[c]=e(s[c]);s=l}$x(o,s)}}}},en=La.registerPlugin({name:"attr",init:function(t,e,n,i,s){var a,o,l;this.tween=n;for(a in e)l=t.getAttribute(a)||"",o=this.add(t,"setAttribute",(l||0)+"",e[a],i,s,0,0,a),o.op=a,o.b=l,this._props.push(a)},render:function(t,e){for(var n=e._pt;n;)Be?n.set(n.t,n.p,n.b,n):n.r(t,n.d),n=n._next}},{name:"endArray",init:function(t,e){for(var n=e.length;n--;)this.add(t,n,t[n]||0,e[n],0,0,0,0,0,1)}},Fo("roundProps",Il),Fo("modifiers"),Fo("snap",ff))||La;Me.version=Ve.version=en.version="3.12.5";Ku=1;lc()&&Vr();Ot.Power0;Ot.Power1;Ot.Power2;Ot.Power3;Ot.Power4;Ot.Linear;Ot.Quad;Ot.Cubic;Ot.Quart;Ot.Quint;Ot.Strong;Ot.Elastic;Ot.Back;Ot.SteppedEase;Ot.Bounce;Ot.Sine;Ot.Expo;Ot.Circ;/*!
 * CSSPlugin 3.12.5
 * https://gsap.com
 *
 ...
 * Club GSAP members, the agreement issued with that membership.
 * @author: Jack Doyle, jack@greensock.com
*/var tu,vi,Pr,xc,Wi,eu,Mc,Jx=function(){return typeof window<"u"},si={},zi=180/Math.PI,Dr=Math.PI/180,vr=Math.atan2,nu=1e8,Sc=/([A-Z])/g,Qx=/(left|right|width|margin|padding|x)/i,tM=/[\s,\(]\S/,On={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},Fl=function(t,e){return e.set(e.t,e.p,Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},eM=function(t,e){return e.set(e.t,e.p,t===1?e.e:Math.round((e.s+e.c*t)*1e4)/1e4+e.u,e)},nM=function(t,e){return e.set(e.t,e.p,t?Math.round((e.s+e.c*t)*1e4)/1e4+e.u:e.b,e)},iM=function(t,e){var n=e.s+e.c*t;e.set(e.t,e.p,~~(n+(n<0?-.5:.5))+e.u,e)},Uf=function(t,e){return e.set(e.t,e.p,t?e.e:e.b,e)},If=function(t,e){return e.set(e.t,e.p,t!==1?e.b:e.e,e)},rM=function(t,e,n){return t.style[e]=n},sM=function(t,e,n){return t.style.setProperty(e,n)},aM=function(t,e,n){return t._gsap[e]=n},oM=function(t,e,n){return t._gsap.scaleX=t._gsap.scaleY=n},lM=function(t,e,n,i,s){var a=t._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},cM=function(t,e,n,i,s){var a=t._gsap;a[e]=n,a.renderTransform(s,a)},he="transform",tn=he+"Origin",hM=function r(t,e){var n=this,i=this.target,s=i.style,a=i._gsap;if(t in si&&s){if(this.tfm=this.tfm||{},t!=="transform")t=On[t]||t,~t.indexOf(",")?t.split(",").forEach(function(o){return n.tfm[o]=Kn(i,o)}):this.tfm[t]=a.x?a[t]:Kn(i,t),t===tn&&(this.tfm.zOrigin=a.zOrigin);else return On.transform.split(",").forEach(function(o){return r.call(n,o,e)});if(this.props.indexOf(he)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(tn,e,"")),t=he}(s||e)&&this.props.push(t,e,s[t])},Nf=function(t){t.translate&&(t.removeProperty("translate"),t.removeProperty("scale"),t.removeProperty("rotate"))},uM=function(){var t=this.props,e=this.target,n=e.style,i=e._gsap,s,a;for(s=0;s<t.length;s+=3)t[s+1]?e[t[s]]=t[s+2]:t[s+2]?n[t[s]]=t[s+2]:n.removeProperty(t[s].substr(0,2)==="--"?t[s]:t[s].replace(Sc,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),e.setAttribute("data-svg-origin",this.svgo||"")),s=Mc(),(!s||!s.isStart)&&!n[he]&&(Nf(n),i.zOrigin&&n[tn]&&(n[tn]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},Of=function(t,e){var n={target:t,props:[],revert:uM,save:hM};return t._gsap||en.core.getCache(t),e&&e.split(",").forEach(function(i){return n.save(i)}),n},Ff,Bl=function(t,e){var n=vi.createElementNS?vi.createElementNS((e||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),t):vi.createElement(t);return n&&n.style?n:vi.createElement(t)},Bn=function r(t,e,n){var i=getComputedStyle(t);return i[e]||i.getPropertyValue(e.replace(Sc,"-$1").toLowerCase())||i.getPropertyValue(e)||!n&&r(t,Gr(e)||e,1)||""},iu="O,Moz,ms,Ms,Webkit".split(","),Gr=function(t,e,n){var i=e||Wi,s=i.style,a=5;if(t in s&&!n)return t;for(t=t.charAt(0).toUpperCase()+t.substr(1);a--&&!(iu[a]+t in s););return a<0?null:(a===3?"ms":a>=0?iu[a]:"")+t},zl=function(){Jx()&&window.document&&(tu=window,vi=tu.document,Pr=vi.documentElement,Wi=Bl("div")||{style:{}},Bl("div"),he=Gr(he),tn=he+"Origin",Wi.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",Ff=!!Gr("perspective"),Mc=en.core.reverting,xc=1)},Bo=function r(t){var e=Bl("svg",this.ownerSVGElement&&this.ownerSVGElement.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),n=this.parentNode,i=this.nextSibling,s=this.style.cssText,a;if(Pr.appendChild(e),e.appendChild(this),this.style.display="block",t)try{a=this.getBBox(),this._gsapBBox=this.getBBox,this.getBBox=r}catch{}else this._gsapBBox&&(a=this._gsapBBox());return n&&(i?n.insertBefore(this,i):n.appendChild(this)),Pr.removeChild(e),this.style.cssText=s,a},ru=function(t,e){for(var n=e.length;n--;)if(t.hasAttribute(e[n]))return t.getAttribute(e[n])},Bf=function(t){var e;try{e=t.getBBox()}catch{e=Bo.call(t,!0)}return e&&(e.width||e.height)||t.getBBox===Bo||(e=Bo.call(t,!0)),e&&!e.width&&!e.x&&!e.y?{x:+ru(t,["x","cx","x1"])||0,y:+ru(t,["y","cy","y1"])||0,width:0,height:0}:e},zf=function(t){return!!(t.getCTM&&(!t.parentNode||t.ownerSVGElement)&&Bf(t))},Qi=function(t,e){if(e){var n=t.style,i;e in si&&e!==tn&&(e=he),n.removeProperty?(i=e.substr(0,2),(i==="ms"||e.substr(0,6)==="webkit")&&(e="-"+e),n.removeProperty(i==="--"?e:e.replace(Sc,"-$1").toLowerCase())):n.removeAttribute(e)}},xi=function(t,e,n,i,s,a){var o=new Qe(t._pt,e,n,0,1,a?If:Uf);return t._pt=o,o.b=i,o.e=s,t._props.push(n),o},su={deg:1,rad:1,turn:1},fM={grid:1,flex:1},wi=function r(t,e,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Wi.style,l=Qx.test(e),c=t.tagName.toLowerCase()==="svg",h=(c?"client":"offset")+(l?"Width":"Height"),u=100,f=i==="px",p=i==="%",g,_,m,d;if(i===a||!s||su[i]||su[a])return s;if(a!=="px"&&!f&&(s=r(t,e,n,"px")),d=t.getCTM&&zf(t),(p||a==="%")&&(si[e]||~e.indexOf("adius")))return g=d?t.getBBox()[l?"width":"height"]:t[h],ge(p?s/g*u:s/100*g);if(o[l?"width":"height"]=u+(f?a:i),_=~e.indexOf("adius")||i==="em"&&t.appendChild&&!c?t:t.parentNode,d&&(_=(t.ownerSVGElement||{}).parentNode),(!_||_===vi||!_.appendChild)&&(_=vi.body),m=_._gsap,m&&p&&m.width&&l&&m.time===on.time&&!m.uncache)return ge(s/m.width*u);if(p&&(e==="height"||e==="width")){var T=t.style[e];t.style[e]=u+i,g=t[h],T?t.style[e]=T:Qi(t,e)}else(p||a==="%")&&!fM[Bn(_,"display")]&&(o.position=Bn(t,"position")),_===t&&(o.position="static"),_.appendChild(Wi),g=Wi[h],_.removeChild(Wi),o.position="absolute";return l&&p&&(m=Xi(_),m.time=on.time,m.width=_[h]),ge(f?g*s/u:g&&s?u/g*s:0)},Kn=function(t,e,n,i){var s;return xc||zl(),e in On&&e!=="transform"&&(e=On[e],~e.indexOf(",")&&(e=e.split(",")[0])),si[e]&&e!=="transform"?(s=ws(t,i),s=e!=="transformOrigin"?s[e]:s.svg?s.origin:Ia(Bn(t,tn))+" "+s.zOrigin+"px"):(s=t.style[e],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Ua[e]&&Ua[e](t,e,n)||Bn(t,e)||tf(t,e)||(e==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?wi(t,e,s,n)+n:s},dM=function(t,e,n,i){if(!n||n==="none"){var s=Gr(e,t,1),a=s&&Bn(t,s,1);a&&a!==n?(e=s,n=a):e==="borderColor"&&(n=Bn(t,"borderTopColor"))}var o=new Qe(this._pt,t.style,e,0,1,Pf),l=0,c=0,h,u,f,p,g,_,m,d,T,E,x,R;if(o.b=n,o.e=i,n+="",i+="",i==="auto"&&(_=t.style[e],t.style[e]=i,i=Bn(t,e)||i,_?t.style[e]=_:Qi(t,e)),h=[n,i],Mf(h),n=h[0],i=h[1],f=n.match(yr)||[],R=i.match(yr)||[],R.length){for(;u=yr.exec(i);)m=u[0],T=i.substring(l,u.index),g?g=(g+1)%5:(T.substr(-5)==="rgba("||T.substr(-5)==="hsla(")&&(g=1),m!==(_=f[c++]||"")&&(p=parseFloat(_)||0,x=_.substr((p+"").length),m.charAt(1)==="="&&(m=Cr(p,m)+x),d=parseFloat(m),E=m.substr((d+"").length),l=yr.lastIndex-E.length,E||(E=E||hn.units[e]||x,l===i.length&&(i+=E,o.e+=E)),x!==E&&(p=wi(t,e,_,E)||0),o._pt={_next:o._pt,p:T||c===1?T:",",s:p,c:d-p,m:g&&g<4||e==="zIndex"?Math.round:0});o.c=l<i.length?i.substring(l,i.length):""}else o.r=e==="display"&&i==="none"?If:Uf;return Zu.test(i)&&(o.e=0),this._pt=o,o},au={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},pM=function(t){var e=t.split(" "),n=e[0],i=e[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(t=n,n=i,i=t),e[0]=au[n]||n,e[1]=au[i]||i,e.join(" ")},mM=function(t,e){if(e.tween&&e.tween._time===e.tween._dur){var n=e.t,i=n.style,s=e.u,a=n._gsap,o,l,c;if(s==="all"||s===!0)i.cssText="",l=1;else for(s=s.split(","),c=s.length;--c>-1;)o=s[c],si[o]&&(l=1,o=o==="transformOrigin"?tn:he),Qi(n,o);l&&(Qi(n,he),a&&(a.svg&&n.removeAttribute("transform"),ws(n,1),a.uncache=1,Nf(i)))}},Ua={clearProps:function(t,e,n,i,s){if(s.data!=="isFromStart"){var a=t._pt=new Qe(t._pt,e,n,0,0,mM);return a.u=i,a.pr=-10,a.tween=s,t._props.push(n),1}}},As=[1,0,0,1,0,0],kf={},Hf=function(t){return t==="matrix(1, 0, 0, 1, 0, 0)"||t==="none"||!t},ou=function(t){var e=Bn(t,he);return Hf(e)?As:e.substr(7).match(qu).map(ge)},yc=function(t,e){var n=t._gsap||Xi(t),i=t.style,s=ou(t),a,o,l,c;return n.svg&&t.getAttribute("transform")?(l=t.transform.baseVal.consolidate().matrix,s=[l.a,l.b,l.c,l.d,l.e,l.f],s.join(",")==="1,0,0,1,0,0"?As:s):(s===As&&!t.offsetParent&&t!==Pr&&!n.svg&&(l=i.display,i.display="block",a=t.parentNode,(!a||!t.offsetParent)&&(c=1,o=t.nextElementSibling,Pr.appendChild(t)),s=ou(t),l?i.display=l:Qi(t,"display"),c&&(o?a.insertBefore(t,o):a?a.appendChild(t):Pr.removeChild(t))),e&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},kl=function(t,e,n,i,s,a){var o=t._gsap,l=s||yc(t,!0),c=o.xOrigin||0,h=o.yOrigin||0,u=o.xOffset||0,f=o.yOffset||0,p=l[0],g=l[1],_=l[2],m=l[3],d=l[4],T=l[5],E=e.split(" "),x=parseFloat(E[0])||0,R=parseFloat(E[1])||0,w,b,C,v;n?l!==As&&(b=p*m-g*_)&&(C=x*(m/b)+R*(-_/b)+(_*T-m*d)/b,v=x*(-g/b)+R*(p/b)-(p*T-g*d)/b,x=C,R=v):(w=Bf(t),x=w.x+(~E[0].indexOf("%")?x/100*w.width:x),R=w.y+(~(E[1]||E[0]).indexOf("%")?R/100*w.height:R)),i||i!==!1&&o.smooth?(d=x-c,T=R-h,o.xOffset=u+(d*p+T*_)-d,o.yOffset=f+(d*g+T*m)-T):o.xOffset=o.yOffset=0,o.xOrigin=x,o.yOrigin=R,o.smooth=!!i,o.origin=e,o.originIsAbsolute=!!n,t.style[tn]="0px 0px",a&&(xi(a,o,"xOrigin",c,x),xi(a,o,"yOrigin",h,R),xi(a,o,"xOffset",u,o.xOffset),xi(a,o,"yOffset",f,o.yOffset)),t.setAttribute("data-svg-origin",x+" "+R)},ws=function(t,e){var n=t._gsap||new Tf(t);if("x"in n&&!e&&!n.uncache)return n;var i=t.style,s=n.scaleX<0,a="px",o="deg",l=getComputedStyle(t),c=Bn(t,tn)||"0",h,u,f,p,g,_,m,d,T,E,x,R,w,b,C,v,S,P,k,O,X,Y,V,q,H,et,at,dt,Tt,Xt,W,J;return h=u=f=_=m=d=T=E=x=0,p=g=1,n.svg=!!(t.getCTM&&zf(t)),l.translate&&((l.translate!=="none"||l.scale!=="none"||l.rotate!=="none")&&(i[he]=(l.translate!=="none"?"translate3d("+(l.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(l.rotate!=="none"?"rotate("+l.rotate+") ":"")+(l.scale!=="none"?"scale("+l.scale.split(" ").join(",")+") ":"")+(l[he]!=="none"?l[he]:"")),i.scale=i.rotate=i.translate="none"),b=yc(t,n.svg),n.svg&&(n.uncache?(H=t.getBBox(),c=n.xOrigin-H.x+"px "+(n.yOrigin-H.y)+"px",q=""):q=!e&&t.getAttribute("data-svg-origin"),kl(t,q||c,!!q||n.originIsAbsolute,n.smooth!==!1,b)),R=n.xOrigin||0,w=n.yOrigin||0,b!==As&&(P=b[0],k=b[1],O=b[2],X=b[3],h=Y=b[4],u=V=b[5],b.length===6?(p=Math.sqrt(P*P+k*k),g=Math.sqrt(X*X+O*O),_=P||k?vr(k,P)*zi:0,T=O||X?vr(O,X)*zi+_:0,T&&(g*=Math.abs(Math.cos(T*Dr))),n.svg&&(h-=R-(R*P+w*O),u-=w-(R*k+w*X))):(J=b[6],Xt=b[7],at=b[8],dt=b[9],Tt=b[10],W=b[11],h=b[12],u=b[13],f=b[14],C=vr(J,Tt),m=C*zi,C&&(v=Math.cos(-C),S=Math.sin(-C),q=Y*v+at*S,H=V*v+dt*S,et=J*v+Tt*S,at=Y*-S+at*v,dt=V*-S+dt*v,Tt=J*-S+Tt*v,W=Xt*-S+W*v,Y=q,V=H,J=et),C=vr(-O,Tt),d=C*zi,C&&(v=Math.cos(-C),S=Math.sin(-C),q=P*v-at*S,H=k*v-dt*S,et=O*v-Tt*S,W=X*S+W*v,P=q,k=H,O=et),C=vr(k,P),_=C*zi,C&&(v=Math.cos(C),S=Math.sin(C),q=P*v+k*S,H=Y*v+V*S,k=k*v-P*S,V=V*v-Y*S,P=q,Y=H),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=ge(Math.sqrt(P*P+k*k+O*O)),g=ge(Math.sqrt(V*V+J*J)),C=vr(Y,V),T=Math.abs(C)>2e-4?C*zi:0,x=W?1/(W<0?-W:W):0),n.svg&&(q=t.getAttribute("transform"),n.forceCSS=t.setAttribute("transform","")||!Hf(Bn(t,he)),q&&t.setAttribute("transform",q))),Math.abs(T)>90&&Math.abs(T)<270&&(s?(p*=-1,T+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,T+=T<=0?180:-180)),e=e||n.uncache,n.x=h-((n.xPercent=h&&(!e&&n.xPercent||(Math.round(t.offsetWidth/2)===Math.round(-h)?-50:0)))?t.offsetWidth*n.xPercent/100:0)+a,n.y=u-((n.yPercent=u&&(!e&&n.yPercent||(Math.round(t.offsetHeight/2)===Math.round(-u)?-50:0)))?t.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=ge(p),n.scaleY=ge(g),n.rotation=ge(_)+o,n.rotationX=ge(m)+o,n.rotationY=ge(d)+o,n.skewX=T+o,n.skewY=E+o,n.transformPerspective=x+a,(n.zOrigin=parseFloat(c.split(" ")[2])||!e&&n.zOrigin||0)&&(i[tn]=Ia(c)),n.xOffset=n.yOffset=0,n.force3D=hn.force3D,n.renderTransform=n.svg?gM:Ff?Vf:_M,n.uncache=0,n},Ia=function(t){return(t=t.split(" "))[0]+" "+t[1]},zo=function(t,e,n){var i=Oe(e);return ge(parseFloat(e)+parseFloat(wi(t,"x",n+"px",i)))+i},_M=function(t,e){e.z="0px",e.rotationY=e.rotationX="0deg",e.force3D=0,Vf(t,e)},Oi="0deg",os="0px",Fi=") ",Vf=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.z,c=n.rotation,h=n.rotationY,u=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,T=n.target,E=n.zOrigin,x="",R=d==="auto"&&t&&t!==1||d===!0;if(E&&(u!==Oi||h!==Oi)){var w=parseFloat(h)*Dr,b=Math.sin(w),C=Math.cos(w),v;w=parseFloat(u)*Dr,v=Math.cos(w),a=zo(T,a,b*v*-E),o=zo(T,o,-Math.sin(w)*-E),l=zo(T,l,C*v*-E+E)}m!==os&&(x+="perspective("+m+Fi),(i||s)&&(x+="translate("+i+"%, "+s+"%) "),(R||a!==os||o!==os||l!==os)&&(x+=l!==os||R?"translate3d("+a+", "+o+", "+l+") ":"translate("+a+", "+o+Fi),c!==Oi&&(x+="rotate("+c+Fi),h!==Oi&&(x+="rotateY("+h+Fi),u!==Oi&&(x+="rotateX("+u+Fi),(f!==Oi||p!==Oi)&&(x+="skew("+f+", "+p+Fi),(g!==1||_!==1)&&(x+="scale("+g+", "+_+Fi),T.style[he]=x||"translate(0, 0)"},gM=function(t,e){var n=e||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,l=n.rotation,c=n.skewX,h=n.skewY,u=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,T=n.forceCSS,E=parseFloat(a),x=parseFloat(o),R,w,b,C,v;l=parseFloat(l),c=parseFloat(c),h=parseFloat(h),h&&(h=parseFloat(h),c+=h,l+=h),l||c?(l*=Dr,c*=Dr,R=Math.cos(l)*u,w=Math.sin(l)*u,b=Math.sin(l-c)*-f,C=Math.cos(l-c)*f,c&&(h*=Dr,v=Math.tan(c-h),v=Math.sqrt(1+v*v),b*=v,C*=v,h&&(v=Math.tan(h),v=Math.sqrt(1+v*v),R*=v,w*=v)),R=ge(R),w=ge(w),b=ge(b),C=ge(C)):(R=u,C=f,w=b=0),(E&&!~(a+"").indexOf("px")||x&&!~(o+"").indexOf("px"))&&(E=wi(p,"x",a,"px"),x=wi(p,"y",o,"px")),(g||_||m||d)&&(E=ge(E+g-(g*R+_*b)+m),x=ge(x+_-(g*w+_*C)+d)),(i||s)&&(v=p.getBBox(),E=ge(E+i/100*v.width),x=ge(x+s/100*v.height)),v="matrix("+R+","+w+","+b+","+C+","+E+","+x+")",p.setAttribute("transform",v),T&&(p.style[he]=v)},vM=function(t,e,n,i,s){var a=360,o=we(s),l=parseFloat(s)*(o&&~s.indexOf("rad")?zi:1),c=l-i,h=i+c+"deg",u,f;return o&&(u=s.split("_")[1],u==="short"&&(c%=a,c!==c%(a/2)&&(c+=c<0?a:-a)),u==="cw"&&c<0?c=(c+a*nu)%a-~~(c/a)*a:u==="ccw"&&c>0&&(c=(c-a*nu)%a-~~(c/a)*a)),t._pt=f=new Qe(t._pt,e,n,i,c,eM),f.e=h,f.u="deg",t._props.push(n),f},lu=function(t,e){for(var n in e)t[n]=e[n];return t},xM=function(t,e,n){var i=lu({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,l,c,h,u,f,p,g;i.svg?(c=n.getAttribute("transform"),n.setAttribute("transform",""),a[he]=e,o=ws(n,1),Qi(n,he),n.setAttribute("transform",c)):(c=getComputedStyle(n)[he],a[he]=e,o=ws(n,1),a[he]=c);for(l in si)c=i[l],h=o[l],c!==h&&s.indexOf(l)<0&&(p=Oe(c),g=Oe(h),u=p!==g?wi(n,l,c,g):parseFloat(c),f=parseFloat(h),t._pt=new Qe(t._pt,o,l,u,f-u,Fl),t._pt.u=g||0,t._props.push(l));lu(o,i)};Je("padding,margin,Width,Radius",function(r,t){var e="Top",n="Right",i="Bottom",s="Left",a=(t<3?[e,n,i,s]:[e+s,e+n,i+n,i+s]).map(function(o){return t<2?r+o:"border"+o+r});Ua[t>1?"border"+r:r]=function(o,l,c,h,u){var f,p;if(arguments.length<4)return f=a.map(function(g){return Kn(o,g,c)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(h+"").split(" "),p={},a.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(l,p,u)}});var Gf={name:"css",register:zl,targetTest:function(t){return t.style&&t.nodeType},init:function(t,e,n,i,s){var a=this._props,o=t.style,l=n.vars.startAt,c,h,u,f,p,g,_,m,d,T,E,x,R,w,b,C;xc||zl(),this.styles=this.styles||Of(t),C=this.styles.props,this.tween=n;for(_ in e)if(_!=="autoRound"&&(h=e[_],!(an[_]&&bf(_,e,n,i,t,s)))){if(p=typeof h,g=Ua[_],p==="function"&&(h=h.call(n,i,t,s),p=typeof h),p==="string"&&~h.indexOf("random(")&&(h=Es(h)),g)g(this,t,_,h,n)&&(b=1);else if(_.substr(0,2)==="--")c=(getComputedStyle(t).getPropertyValue(_)+"").trim(),h+="",Ei.lastIndex=0,Ei.test(c)||(m=Oe(c),d=Oe(h)),d?m!==d&&(c=wi(t,_,c,d)+d):m&&(h+=m),this.add(o,"setProperty",c,h,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(p!=="undefined"){if(l&&_ in l?(c=typeof l[_]=="function"?l[_].call(n,i,t,s):l[_],we(c)&&~c.indexOf("random(")&&(c=Es(c)),Oe(c+"")||c==="auto"||(c+=hn.units[_]||Oe(Kn(t,_))||""),(c+"").charAt(1)==="="&&(c=Kn(t,_))):c=Kn(t,_),f=parseFloat(c),T=p==="string"&&h.charAt(1)==="="&&h.substr(0,2),T&&(h=h.substr(2)),u=parseFloat(h),_ in On&&(_==="autoAlpha"&&(f===1&&Kn(t,"visibility")==="hidden"&&u&&(f=0),C.push("visibility",0,o.visibility),xi(this,o,"visibility",f?"inherit":"hidden",u?"inherit":"hidden",!u)),_!=="scale"&&_!=="transform"&&(_=On[_],~_.indexOf(",")&&(_=_.split(",")[0]))),E=_ in si,E){if(this.styles.save(_),x||(R=t._gsap,R.renderTransform&&!e.parseTransform||ws(t,e.parseTransform),w=e.smoothOrigin!==!1&&R.smooth,x=this._pt=new Qe(this._pt,o,he,0,1,R.renderTransform,R,0,-1),x.dep=1),_==="scale")this._pt=new Qe(this._pt,R,"scaleY",R.scaleY,(T?Cr(R.scaleY,T+u):u)-R.scaleY||0,Fl),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(tn,0,o[tn]),h=pM(h),R.svg?kl(t,h,0,w,0,this):(d=parseFloat(h.split(" ")[2])||0,d!==R.zOrigin&&xi(this,R,"zOrigin",R.zOrigin,d),xi(this,o,_,Ia(c),Ia(h)));continue}else if(_==="svgOrigin"){kl(t,h,1,w,0,this);continue}else if(_ in kf){vM(this,R,_,f,T?Cr(f,T+h):h);continue}else if(_==="smoothOrigin"){xi(this,R,"smooth",R.smooth,h);continue}else if(_==="force3D"){R[_]=h;continue}else if(_==="transform"){xM(this,h,t);continue}}else _ in o||(_=Gr(_)||_);if(E||(u||u===0)&&(f||f===0)&&!tM.test(h)&&_ in o)m=(c+"").substr((f+"").length),u||(u=0),d=Oe(h)||(_ in hn.units?hn.units[_]:m),m!==d&&(f=wi(t,_,c,d)),this._pt=new Qe(this._pt,E?R:o,_,f,(T?Cr(f,T+u):u)-f,!E&&(d==="px"||_==="zIndex")&&e.autoRound!==!1?iM:Fl),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=c,this._pt.r=nM);else if(_ in o)dM.call(this,t,_,c,T?T+h:h);else if(_ in t)this.add(t,_,c||t[_],T?T+h:h,i,s);else if(_!=="parseTransform"){hc(_,h);continue}E||(_ in o?C.push(_,0,o[_]):C.push(_,1,c||t[_])),a.push(_)}}b&&Df(this)},render:function(t,e){if(e.tween._time||!Mc())for(var n=e._pt;n;)n.r(t,n.d),n=n._next;else e.styles.revert()},get:Kn,aliases:On,getSetter:function(t,e,n){var i=On[e];return i&&i.indexOf(",")<0&&(e=i),e in si&&e!==tn&&(t._gsap.x||Kn(t,"x"))?n&&eu===n?e==="scale"?oM:aM:(eu=n||{})&&(e==="scale"?lM:cM):t.style&&!oc(t.style[e])?rM:~e.indexOf("-")?sM:gc(t,e)},core:{_removeProperty:Qi,_getMatrix:yc}};en.utils.checkPrefix=Gr;en.core.getStyleSaver=Of;(function(r,t,e,n){var i=Je(r+","+t+","+e,function(s){si[s]=1});Je(t,function(s){hn.units[s]="deg",kf[s]=1}),On[i[13]]=r+","+t,Je(n,function(s){var a=s.split(":");On[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Je("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){hn.units[r]="px"});en.registerPlugin(Gf);var Hl=en.registerPlugin(Gf)||en;Hl.core.Tween;const Wf=qv();ei.domElement;const Ec=document.getElementById("horisontalCountInput"),Tc=document.getElementById("verticalCountInput"),bc=document.getElementById("length"),Ac=document.getElementById("height"),wc=document.getElementById("depth"),MM=document.getElementById("ModalButton");bc.addEventListener("input",Jr);Ac.addEventListener("input",Jr);wc.addEventListener("input",Jr);MM.addEventListener("click",RM);Ec.addEventListener("input",Jr);Tc.addEventListener("input",Jr);const SM=document.getElementById("openDoorsButton");SM.addEventListener("click",()=>ix());const yM=document.getElementById("openDrawersButton");yM.addEventListener("click",Jv);const EM=document.getElementById("closeDrawersButton");EM.addEventListener("click",Qv);const TM=document.getElementById("openDoorsDoubleButton");TM.addEventListener("click",()=>rx());const bM=document.getElementById("closeDoorsDoubleButton");bM.addEventListener("click",()=>sx());let Ie=parseFloat(bc.value)||1,qe=parseFloat(Ac.value)||1,Ue=parseFloat(wc.value)||1,ya=parseFloat(Ec.value),Ea=parseFloat(Tc.value);const Wr=new Fe;ve.add(Wr);let ua=new Fe,AM=new Fe,_s=new Fe,gs=new Fe,Vl=Ie/Ea,Gl=qe/ya;Gt.cellWidth=Vl;Gt.cellHeight=Gl;_s.castShadow=!0;gs.castShadow=!0;ve.add(_s,gs,AM);function wM(){let r=Gt.HorisontalPartitionCount,t=Gt.VerticalPartitionCount;const e=Gt.cellWidth,n=Gt.cellHeight;ve.remove(ua),ua=new Fe;const i=new Zt(.1,qe-.1,Ue),s=new Kt(new Zt(Ie+.1,.1,Ue),Ze),a=new Kt(new Zt(Ie+.1,.1,Ue),Ze),o=new Kt(new Zt(Ie+.2,qe,.05),new jr({color:"white"}));s.position.set(0,qe,Ue/2),a.position.set(0,0,Ue/2);const l=new Kt(i,Ze),c=new Kt(i,Ze);l.position.set(-Ie/2,qe/2,Ue/2),c.position.set(Ie/2,qe/2,Ue/2),o.position.set(0,qe/2,-.025),ye(a),ye(l),ye(c),ye(s),Wr.clear(),l.castShadow=!0,c.castShadow=!0,s.castShadow=!0,a.castShadow=!0,o.castShadow=!0,l.receiveShadow=!0,c.receiveShadow=!0,s.receiveShadow=!0,a.receiveShadow=!0,o.receiveShadow=!0,ua.add(l,c,s,a),_s.clear();for(let h=1;h<r;h++){const u=h*qe/r;for(let f=0;f<t;f++){const p=(f+.5)*(Ie/t),g=new Kt(new Zt(Ie/t-.12,.1,Ue),Ze);ye(g),g.position.set(p-Ie/2,u,Ue/2),_s.add(g)}}gs.clear();for(let h=1;h<t;h++){const u=h*Ie/t,f=new Kt(new Zt(.1,qe-.1,Ue),Ze);ye(f),f.position.set(u-Ie/2,qe/2,Ue/2),gs.add(f)}ve.add(ua),ve.add(_s),ve.add(gs);for(let h=0;h<t;h++)for(let u=0;u<r;u++){const f=new Kt(new Zt(e,n,Ue),new Ps({color:"white",transparent:!0,opacity:0}));f.position.set((h+.5)*e-Ie/2,(u+.5)*n,Ue/2);let p=(h+.5)*e-Ie/2,g=(u+.5)*n,_=Ue/2;Re.push({xp:p,yp:g,zp:_}),Wr.add(f)}nx(),$v()}function Jr(){Ie=parseFloat(bc.value),qe=parseFloat(Ac.value),Ue=parseFloat(wc.value),ya=parseFloat(Ec.value),Ea=parseFloat(Tc.value),Vl=Ie/Ea,Gl=qe/ya,Gt.length=Ie,Gt.height=qe,Gt.depth=Ue,Gt.HorisontalPartitionCount=ya,Gt.VerticalPartitionCount=Ea,Gt.cellWidth=Vl,Gt.cellHeight=Gl,Re.length=0,wM();const r=new N(7,qe/2,5);Wf.target.copy(r)}let fa;window.addEventListener("mousemove",r=>{ni.x=r.clientX/window.innerWidth*2-1,ni.y=-(r.clientY/window.innerHeight)*2+1,Br.setFromCamera(ni,$r);const t=Br.intersectObjects(Wr.children);if(Wr.children.forEach(e=>{e.material.color.set("green"),e.material.opacity=0}),t.length>0){const e=t[0].object;e.material.color.set("white"),e.material.opacity=.2}});window.addEventListener("mousemove",r=>{ni.x=r.clientX/window.innerWidth*2-1,ni.y=-(r.clientY/window.innerHeight)*2+1,Br.setFromCamera(ni,$r);const t=Br.intersectObjects(Gu);if(t.length>0){const n=t[0].object.parent;Hl.to(n.position,{z:Gt.depth/2,duration:.8,ease:"power2.inout"})}else wa.children.forEach(e=>{Hl.to(e.position,{z:0,duration:2,ease:"power2.inout"})})});window.addEventListener("click",r=>{ni.x=r.clientX/window.innerWidth*2-1,ni.y=-(r.clientY/window.innerHeight)*2+1,Br.setFromCamera(ni,$r);const t=Br.intersectObjects(Wr.children);if(t.length>0){const e=t[0];let n=e.object.position.x,i=e.object.position.y,s;Re.forEach((a,o)=>{a.xp==n&&a.yp==i&&(s=o)}),ex(s)}});function RM(){let r=parseInt(jv.value);const t=`${fa.cellX}-${fa.cellY}`;switch(r){case 1:Po.hide();const e=_i[t];e&&(ve.remove(e.group),delete _i[t]),tx(fa);break;case 2:Po.hide();const n=ln[t];n&&(ve.remove(n.mesh),delete ln[t]);debugger;Kv(fa);break;case 4:Po.hide();const i=_i[t],s=ln[t];i&&(ve.remove(i.group),delete _i[t]),s&&(ve.remove(s.mesh),delete ln[t]);break}}console.log(Gt);Jr();function Xf(){requestAnimationFrame(Xf),Wf.update(),ei.render(ve,$r)}Xf();
